var e={hex:62,hex_font:`䷽`,trad_chinese:`小過`,pinyin:`xiǎoguò`,english:`Small Exceeding`,binary:`001100`,od:61,wilhelm_above:{chinese:`CHêN`,symbolic:`The Arousing`,alchemical:`Thunder`},wilhelm_below:{chinese:`KêN`,symbolic:`Keeping Still`,alchemical:`Mountain`},wilhelm_symbolic:`While in the hexagram Ta Kuo, Great Exceeding

28, the strong lines preponderate and are within, inclosed between weak lines at the top and bottom, the present hexagram has weak lines preponderating, though here again they are on the outside, the strong lines being within. This indeed is the basis of the exceptional situation indicated by the hexagram. When strong lines are outside, we have the hexagram I, Nourishment

27, or Chung Fu, Inner Truth,

61; neither represents and exceptional state. When strong elements within preponderate, they necessarily enforce their will. This creates struggle and exceptional conditions in general. But in the present hexagram it is the weak element that perforce must mediate with the outside world. If a man occupies a position of authority for which he is by nature really inadequate, extraordinary prudence is necessary.`,wilhelm_judgment:{text:`Small Exceeding. Success.
