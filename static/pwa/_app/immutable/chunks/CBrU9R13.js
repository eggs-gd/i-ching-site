import{B as e,D as t,E as n,H as r,J as i,K as a,N as o,O as s,P as c,Q as l,R as u,S as d,T as f,U as p,V as m,W as h,X as g,Y as _,Z as v,a as y,b,d as x,f as ee,h as S,l as C,q as te,s as ne,t as w,v as T,w as re,x as E,y as D,z as O}from"./Dr4kgHLz.js";import"./xihTtKlq.js";var k=[`uk`,`en`],A={app:{title:`I Ching: Shape of Momentum`,tagline:`What is happening already has a shape`,description:`Symbolic I Ching reading — scene, dynamics, vector`,scrollToTop:`Back to top`},profile:{open:`Profile`,title:`Profile`,export:`Export archive`,clearArchive:`Clear archive`,archiveTitle:`Archive`,archiveEmpty:`No entries`,selectAll:`All`,deleteSelected:`Delete ({count})`},flow:{contextLabel:`What draws your attention?`,contextHelpTitle:`What draws your attention?`,contextHelpBody:`Enter your question, or a description of the situation that concerns you right now.`,contextPlaceholder:`Work, conflict, decision, question…`,castConfirm:`Cast`,castingLabel:`Cast a hexagram`,virtualCoinsLabel:`Virtual coins`,virtualCoinsHelpTitle:`Virtual coins`,virtualCoinsHelpBody:`Traditional coin casting directly in the app.

Choose the pace that suits you.`,realCoinsLabel:`Real coins`,realCoinsHelpTitle:`Real coins`,realCoinsHelpBody:`For readings made with real coins or an already completed cast.`,castSingle:`Coin by coin`,castLine:`Line by line`,castFull:`All at once`,tossing:`Tossing…`,building:`Building the hexagram…`,newCast:`Another question`,newCastLink:`Another question →`,tossSingle:`Toss coin`,tossLine:`Toss line`,explain:`Explain`,explanationPaidBody:`A personalized cast explanation is a paid feature.`,formReady:`Hexagram already cast`,lowerTrigram:`Lower trigram`,upperTrigram:`Upper trigram`,yourQuestion:`Your question:`,questionInputLabel:`Your question:`,ichingAnswer:`I Ching answer`,manualSubmit:`Show`,selectHexagram:`Choose hexagram`,clearHexagram:`Clear selection`,manualQuestionRequired:`Add your question.`,manualPrimaryInvalid:`Choose an entry hexagram.`,manualSubmitFailed:`Could not save the cast. Check the hexagram numbers.`},coins:{gridLabel:`Cast coins`,yang:`Yang — heads`,yangShort:`Yang`,yin:`Yin — tails`,yinShort:`Yin`,pending:`Coin not yet tossed`},reading:{entryHexagramLabel:`Entry hexagram`,stateHexagramLabel:`State hexagram`,relatingLabel:`Exit hexagram`,changingLinesTitle:`Transition through lines: {lines}`,changingLinesHelpTitle:`Transition lines`,changingLinesHelpBody:`Transition lines show where the structure of the situation has already lost stability.

They do not mark individual events, but places of tension, transition, or excess, through which one form gradually changes into another.

Each transition line points to a phase of the process where movement can no longer remain unchanged.`,primaryHexagramHelpTitle:`Entry hexagram`,primaryHexagramHelpBody:`The entry hexagram shows the form from which movement begins.

It describes the initial state of the situation: where tension arises, what has already lost stability, and which process begins to change direction.`,stateHexagramHelpTitle:`State hexagram`,stateHexagramHelpBody:`The state hexagram shows the current form of the situation.

It describes the tension of the moment, its boundaries, inner order, and the way the situation holds itself right now.`,relatingHexagramHelpTitle:`Exit hexagram`,relatingHexagramHelpBody:`The exit hexagram shows the form toward which the situation gradually transitions.

It does not give a final result or forecast, but shows the new state of equilibrium that begins to take shape after the change.`,helpClose:`Close`,extendedOpen:`Extended`},journal:{title:`Archive`,export:`Export`,exportTitle:`Export archive`,exportAction:`Export`,exportShare:`Share`,exportDownload:`Download`,exportCopy:`Copy`,exportCopied:`Copied`,helpTitle:`Archive`,helpBody:`Your question history and recurring hexagrams are stored here.

You can clear it from your profile.`,motifs:`Echoes`,trackForm:`Track the motifs`,trackFormPaidBody:`Tracking the situation's form is a paid feature.`,openEntry:`Open cast reading`,openMotif:`Open hexagram: {name}`},trigrams:{qian:`Heaven`,kun:`Earth`,zhen:`Thunder`,kan:`Water`,gen:`Mountain`,xun:`Wind`,li:`Fire`,dui:`Lake`},locale:{label:`Language`,uk:`Українська`,en:`English`}},j={app:{title:`I Ching: Shape of Momentum`,tagline:`Те, що відбувається, вже має форму`,description:`Символічне читання І-Цзин — образ, динаміка, вектор`,scrollToTop:`На початок`},profile:{open:`Профіль`,title:`Профіль`,export:`Експорт архіву`,clearArchive:`Очистити архів`,archiveTitle:`Архів`,archiveEmpty:`Записів немає`,selectAll:`Усі`,deleteSelected:`Видалити ({count})`},flow:{contextLabel:`Що привертає вашу увагу?`,contextHelpTitle:`Що привертає вашу увагу?`,contextHelpBody:`Введіть своє питання, або опис ситуації яка вас турбує на даний момент`,contextPlaceholder:`Робота, конфлікт, рішення, питання…`,castConfirm:`Кидати`,castingLabel:`Скласти гексаграму`,virtualCoinsLabel:`Віртуальні монети`,virtualCoinsHelpTitle:`Віртуальні монети`,virtualCoinsHelpBody:`Класичний кидок монет прямо в додатку.

Оберіть темп, який вам підходить.`,realCoinsLabel:`Живі монети`,realCoinsHelpTitle:`Живі монети`,realCoinsHelpBody:`Для роботи зі справжніми монетами або вже готовим результатом кидка.`,castSingle:`По одній монеті`,castLine:`Лінія за лінією`,castFull:`Всі разом`,tossing:`Кидок…`,building:`Побудова гексаграми…`,newCast:`Інше питання`,newCastLink:`Інше питання →`,tossSingle:`Кинути монету`,tossLine:`Кинути лінію`,explain:`Пояснити`,explanationPaidBody:`Персоналізоване пояснення кидка — платна функція.`,formReady:`Гексаграма вже складена`,lowerTrigram:`Нижня триграма`,upperTrigram:`Верхня триграма`,yourQuestion:`Ваше питання:`,questionInputLabel:`Ваше питання:`,ichingAnswer:`Відповідь І-Цзина`,manualSubmit:`Показати`,selectHexagram:`Оберіть гексаграму`,clearHexagram:`Очистити вибір`,manualQuestionRequired:`Додайте питання.`,manualPrimaryInvalid:`Оберіть гексаграму входу.`,manualSubmitFailed:`Не вдалося зберегти кидок. Перевірте номери гексаграм.`},coins:{gridLabel:`Монети кидка`,yang:`Ян — орел`,yangShort:`Ян`,yin:`Інь — решка`,yinShort:`Інь`,pending:`Монета ще не кинута`},reading:{entryHexagramLabel:`Гексаграма входу`,stateHexagramLabel:`Гексаграма стану`,relatingLabel:`Гексаграма виходу`,changingLinesTitle:`Перехід через лінії: {lines}`,changingLinesHelpTitle:`Перехідні лінії`,changingLinesHelpBody:`Перехідні лінії показують, де структура ситуації вже втратила стабільність.

Вони позначають не окремі події, а місця напруги, переходу або перевищення, через які одна форма поступово змінюється на іншу.

Кожна перехідна лінія вказує на фазу процесу, де рух уже не може залишатись незмінним.`,primaryHexagramHelpTitle:`Гексаграма входу`,primaryHexagramHelpBody:`Гексаграма входу показує, з якої форми починається рух.

Вона описує початковий стан ситуації: де виникає напруга, що вже втратило стабільність, і який процес починає змінювати свій напрям.`,stateHexagramHelpTitle:`Гексаграма стану`,stateHexagramHelpBody:`Гексаграма стану показує поточну форму ситуації.

Вона описує напругу моменту, його межі, внутрішній порядок і спосіб, у який ситуація утримує себе зараз.`,relatingHexagramHelpTitle:`Гексаграма виходу`,relatingHexagramHelpBody:`Гексаграма виходу показує форму, у яку поступово переходить ситуація.

Вона не дає фінального результату чи прогнозу, а показує новий стан рівноваги, який починає складатися після зміни.`,helpClose:`Закрити`,extendedOpen:`Розширено`},journal:{title:`Архів`,export:`Експорт`,exportTitle:`Експорт архіву`,exportAction:`Експорт`,exportShare:`Поділитися`,exportDownload:`Завантажити`,exportCopy:`Копіювати`,exportCopied:`Скопійовано`,helpTitle:`Архів`,helpBody:`Тут зберігається історія ваших питань і повторювані гексаграми

Можна очистити через профіль`,motifs:`Відлуння`,trackForm:`Простежити мотиви`,trackFormPaidBody:`Простеження мотивів — платна функція.`,openEntry:`Відкрити пояснення кидка`,openMotif:`Відкрити гексаграму: {name}`},trigrams:{qian:`Небо`,kun:`Земля`,zhen:`Грім`,kan:`Вода`,gen:`Гора`,xun:`Вітер`,li:`Вогонь`,dui:`Озеро`},locale:{label:`Мова`,uk:`Українська`,en:`English`}},M=`i-ching-locale`,N={uk:j,en:A};function ie(e,t){return t.split(`.`).reduce((e,t)=>{if(e&&typeof e==`object`&&t in e)return e[t]},e)}function P(e,t){return t?e.replace(/\{(\w+)\}/g,(e,n)=>String(t[n]??`{${n}}`)):e}function F(){{let e=localStorage.getItem(M);if(e&&k.includes(e))return e;if(navigator.language.toLowerCase().startsWith(`uk`))return`uk`}return`en`}function I(e,t,n){let r=ie(N[e],t);return typeof r==`string`?P(r,n):t}function ae(e){return e===`uk`?`uk-UA`:`en-GB`}var L=M,oe={uk:{1:`Зародження · перший рух · поява напрямку`,2:`Зустріч із середовищем · набір форми`,3:`Опір · перевірка життєздатності`,4:`Вихід назовні · зміна масштабу`,5:`Зрілість · центр ваги · повна сила`,6:`Межа · виснаження · перехід або завершення`},en:{1:`Emergence · first movement · direction appears`,2:`Contact with the world · taking shape`,3:`Resistance · test of viability`,4:`Stepping outward · change of scale`,5:`Maturity · center of gravity · full strength`,6:`Limit · exhaustion · transition or completion`}},se=[6,5,4,3,2,1];function ce(e,t){return oe[t]?.[String(e)]||(oe.en[String(e)]??``)}var R;(function(e){e.Unimplemented=`UNIMPLEMENTED`,e.Unavailable=`UNAVAILABLE`})(R||={});var le=class extends Error{constructor(e,t,n){super(e),this.message=e,this.code=t,this.data=n}},ue=e=>e?.androidBridge?`android`:e?.webkit?.messageHandlers?.bridge?`ios`:`web`,de=e=>{let t=e.CapacitorCustomPlatform||null,n=e.Capacitor||{},r=n.Plugins=n.Plugins||{},i=()=>t===null?ue(e):t.name,a=()=>i()!==`web`,o=e=>!!(l.get(e)?.platforms.has(i())||s(e)),s=e=>n.PluginHeaders?.find(t=>t.name===e),c=t=>e.console.error(t),l=new Map;return n.convertFileSrc||=e=>e,n.getPlatform=i,n.handleError=c,n.isNativePlatform=a,n.isPluginAvailable=o,n.registerPlugin=(e,a={})=>{let o=l.get(e);if(o)return console.warn(`Capacitor plugin "${e}" already registered. Cannot register plugins twice.`),o.proxy;let c=i(),u=s(e),d,f=async()=>(!d&&c in a?d=d=typeof a[c]==`function`?await a[c]():a[c]:t!==null&&!d&&`web`in a&&(d=d=typeof a.web==`function`?await a.web():a.web),d),p=(t,r)=>{if(u){let i=u?.methods.find(e=>r===e.name);if(i)return i.rtype===`promise`?t=>n.nativePromise(e,r.toString(),t):(t,i)=>n.nativeCallback(e,r.toString(),t,i);if(t)return t[r]?.bind(t)}else if(t)return t[r]?.bind(t);else throw new le(`"${e}" plugin is not implemented on ${c}`,R.Unimplemented)},m=t=>{let n,r=(...r)=>{let i=f().then(i=>{let a=p(i,t);if(a){let e=a(...r);return n=e?.remove,e}else throw new le(`"${e}.${t}()" is not implemented on ${c}`,R.Unimplemented)});return t===`addListener`&&(i.remove=async()=>n()),i};return r.toString=()=>`${t.toString()}() { [capacitor code] }`,Object.defineProperty(r,"name",{value:t,writable:!1,configurable:!1}),r},h=m(`addListener`),g=m(`removeListener`),_=(e,t)=>{let n=h({eventName:e},t),r=async()=>{g({eventName:e,callbackId:await n},t)},i=new Promise(e=>n.then(()=>e({remove:r})));return i.remove=async()=>{console.warn(`Using addListener() without 'await' is deprecated.`),await r()},i},v=new Proxy({},{get(e,t){switch(t){case`$$typeof`:return;case`toJSON`:return()=>({});case`addListener`:return u?_:h;case`removeListener`:return g;default:return m(t)}}});return r[e]=v,l.set(e,{name:e,proxy:v,platforms:new Set([...Object.keys(a),...u?[c]:[]])}),v},n.Exception=le,n.DEBUG=!!n.DEBUG,n.isLoggingEnabled=!!n.isLoggingEnabled,n},z=(e=>e.Capacitor=de(e))(typeof globalThis<`u`?globalThis:typeof self<`u`?self:typeof window<`u`?window:typeof global<`u`?global:{}),B=z.registerPlugin,fe=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,t){let n=!1;this.listeners[e]||(this.listeners[e]=[],n=!0),this.listeners[e].push(t);let r=this.windowListeners[e];return r&&!r.registered&&this.addWindowListener(r),n&&this.sendRetainedArgumentsForEvent(e),Promise.resolve({remove:async()=>this.removeListener(e,t)})}async removeAllListeners(){this.listeners={};for(let e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t,n){let r=this.listeners[e];if(!r){if(n){let n=this.retainedEventArguments[e];n||=[],n.push(t),this.retainedEventArguments[e]=n}return}r.forEach(e=>e(t))}hasListeners(e){return!!this.listeners[e]?.length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:e=>{this.notifyListeners(t,e)}}}unimplemented(e=`not implemented`){return new z.Exception(e,R.Unimplemented)}unavailable(e=`not available`){return new z.Exception(e,R.Unavailable)}async removeListener(e,t){let n=this.listeners[e];if(!n)return;let r=n.indexOf(t);this.listeners[e].splice(r,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){let t=this.retainedEventArguments[e];t&&(delete this.retainedEventArguments[e],t.forEach(t=>{this.notifyListeners(e,t)}))}},pe=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),me=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),he=class extends fe{async getCookies(){let e=document.cookie,t={};return e.split(`;`).forEach(e=>{if(e.length<=0)return;let[n,r]=e.replace(/=/,`CAP_COOKIE`).split(`CAP_COOKIE`);n=me(n).trim(),r=me(r).trim(),t[n]=r}),t}async setCookie(e){try{let t=pe(e.key),n=pe(e.value),r=e.expires?`; expires=${e.expires.replace(`expires=`,``)}`:``,i=(e.path||`/`).replace(`path=`,``),a=e.url!=null&&e.url.length>0?`domain=${e.url}`:``;document.cookie=`${t}=${n||``}${r}; path=${i}; ${a};`}catch(e){return Promise.reject(e)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(e){return Promise.reject(e)}}async clearCookies(){try{let e=document.cookie.split(`;`)||[];for(let t of e)document.cookie=t.replace(/^ +/,``).replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}};B(`CapacitorCookies`,{web:()=>new he});var ge=async e=>new Promise((t,n)=>{let r=new FileReader;r.onload=()=>{let e=r.result;t(e.indexOf(`,`)>=0?e.split(`,`)[1]:e)},r.onerror=e=>n(e),r.readAsDataURL(e)}),_e=(e={})=>{let t=Object.keys(e);return Object.keys(e).map(e=>e.toLocaleLowerCase()).reduce((n,r,i)=>(n[r]=e[t[i]],n),{})},ve=(e,t=!0)=>e?Object.entries(e).reduce((e,n)=>{let[r,i]=n,a,o;return Array.isArray(i)?(o=``,i.forEach(e=>{a=t?encodeURIComponent(e):e,o+=`${r}=${a}&`}),o.slice(0,-1)):(a=t?encodeURIComponent(i):i,o=`${r}=${a}`),`${e}&${o}`},``).substr(1):null,ye=(e,t={})=>{let n=Object.assign({method:e.method||`GET`,headers:e.headers},t),r=_e(e.headers)[`content-type`]||``;if(typeof e.data==`string`)n.body=e.data;else if(r.includes(`application/x-www-form-urlencoded`)){let t=new URLSearchParams;for(let[n,r]of Object.entries(e.data||{}))t.set(n,r);n.body=t.toString()}else if(r.includes(`multipart/form-data`)||e.data instanceof FormData){let t=new FormData;if(e.data instanceof FormData)e.data.forEach((e,n)=>{t.append(n,e)});else for(let n of Object.keys(e.data))t.append(n,e.data[n]);n.body=t;let r=new Headers(n.headers);r.delete(`content-type`),n.headers=r}else (r.includes(`application/json`)||typeof e.data==`object`)&&(n.body=JSON.stringify(e.data));return n},be=class extends fe{async request(e){let t=ye(e,e.webFetchExtra),n=ve(e.params,e.shouldEncodeUrlParams),r=n?`${e.url}?${n}`:e.url,i=await fetch(r,t),a=i.headers.get(`content-type`)||``,{responseType:o=`text`}=i.ok?e:{};a.includes(`application/json`)&&(o=`json`);let s,c;switch(o){case`arraybuffer`:case`blob`:c=await i.blob(),s=await ge(c);break;case`json`:s=await i.json();break;default:s=await i.text()}let l={};return i.headers.forEach((e,t)=>{l[t]=e}),{data:s,headers:l,status:i.status,url:i.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:`GET`}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:`POST`}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:`PUT`}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:`PATCH`}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:`DELETE`}))}};B(`CapacitorHttp`,{web:()=>new be});var xe;(function(e){e.Dark=`DARK`,e.Light=`LIGHT`,e.Default=`DEFAULT`})(xe||={});var Se;(function(e){e.StatusBar=`StatusBar`,e.NavigationBar=`NavigationBar`})(Se||={});var Ce=class extends fe{async setStyle(){this.unavailable(`not available for web`)}async setAnimation(){this.unavailable(`not available for web`)}async show(){this.unavailable(`not available for web`)}async hide(){this.unavailable(`not available for web`)}};B(`SystemBars`,{web:()=>new Ce});var V=B(`Preferences`,{web:()=>w(()=>import(`./CO9Hmg5p.js`).then(e=>new e.PreferencesWeb),[],import.meta.url)}),we=Symbol(`i18n`),Te=class{#e=p(m(F()));get locale(){return s(this.#e)}set locale(e){r(this.#e,e,!0)}setLocale(e){this.locale=e,localStorage.setItem(L,e),document.documentElement.lang=e,z.isNativePlatform()&&V.set({key:L,value:e})}t(e,t){return I(this.locale,e,t)}};async function Ee(e){if(!z.isNativePlatform())return;let{value:t}=await V.get({key:L});(t===`uk`||t===`en`)&&e.setLocale(t)}function De(){let e=new Te;return _(we,e),document.documentElement.lang=e.locale,Ee(e),e}function Oe(){return a(we)}var H=`i-ching-journal`,ke=`journal_migrated`;function Ae(e){return`primaryNumber`in e&&typeof e.primaryNumber==`number`?{...e,relatingNumber:e.relatingNumber??e.relating?.number}:{id:e.id,createdAt:e.createdAt,question:e.question,primaryNumber:e.primary?.number??1,relatingNumber:e.relating?.number,changingLines:e.changingLines,lines:e.lines,coinRows:e.coinRows,locale:e.locale,method:e.method,note:e.note}}var je=class{async ensureReady(){}async loadAll(){if(typeof localStorage>`u`)return[];try{let e=localStorage.getItem(H);return e?JSON.parse(e).map(Ae):[]}catch{return[]}}async save(e){if(typeof localStorage>`u`)return;let t=await this.loadAll();t.unshift(e),localStorage.setItem(H,JSON.stringify(t))}async deleteByIds(e){if(typeof localStorage>`u`||e.length===0)return;let t=new Set(e),n=(await this.loadAll()).filter(e=>!t.has(e.id));localStorage.setItem(H,JSON.stringify(n))}},Me=class{constructor(e){this.sqlite=e,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(e){return Promise.reject(e)}}async saveToStore(e){try{return await this.sqlite.saveToStore({database:e}),Promise.resolve()}catch(e){return Promise.reject(e)}}async saveToLocalDisk(e){try{return await this.sqlite.saveToLocalDisk({database:e}),Promise.resolve()}catch(e){return Promise.reject(e)}}async getFromLocalDiskToStore(e){let t=e??!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:t}),Promise.resolve()}catch(e){return Promise.reject(e)}}async echo(e){try{let t=await this.sqlite.echo({value:e});return Promise.resolve(t)}catch(e){return Promise.reject(e)}}async isSecretStored(){try{let e=await this.sqlite.isSecretStored();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async setEncryptionSecret(e){try{return await this.sqlite.setEncryptionSecret({passphrase:e}),Promise.resolve()}catch(e){return Promise.reject(e)}}async changeEncryptionSecret(e,t){try{return await this.sqlite.changeEncryptionSecret({passphrase:e,oldpassphrase:t}),Promise.resolve()}catch(e){return Promise.reject(e)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(e){return Promise.reject(e)}}async checkEncryptionSecret(e){try{let t=await this.sqlite.checkEncryptionSecret({passphrase:e});return Promise.resolve(t)}catch(e){return Promise.reject(e)}}async addUpgradeStatement(e,t){try{return e.endsWith(`.db`)&&(e=e.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:e,upgrade:t}),Promise.resolve()}catch(e){return Promise.reject(e)}}async createConnection(e,t,n,r,i){try{e.endsWith(`.db`)&&(e=e.slice(0,-3)),await this.sqlite.createConnection({database:e,encrypted:t,mode:n,version:r,readonly:i});let a=new Ne(e,i,this.sqlite),o=i?`RO_${e}`:`RW_${e}`;return this._connectionDict.set(o,a),Promise.resolve(a)}catch(e){return Promise.reject(e)}}async closeConnection(e,t){try{e.endsWith(`.db`)&&(e=e.slice(0,-3)),await this.sqlite.closeConnection({database:e,readonly:t});let n=t?`RO_${e}`:`RW_${e}`;return this._connectionDict.delete(n),Promise.resolve()}catch(e){return Promise.reject(e)}}async isConnection(e,t){let n={};e.endsWith(`.db`)&&(e=e.slice(0,-3));let r=t?`RO_${e}`:`RW_${e}`;return n.result=this._connectionDict.has(r),Promise.resolve(n)}async retrieveConnection(e,t){e.endsWith(`.db`)&&(e=e.slice(0,-3));let n=t?`RO_${e}`:`RW_${e}`;if(this._connectionDict.has(n)){let t=this._connectionDict.get(n);return t===void 0?Promise.reject(`Connection ${e} is undefined`):Promise.resolve(t)}else return Promise.reject(`Connection ${e} does not exist`)}async getNCDatabasePath(e,t){try{let n=await this.sqlite.getNCDatabasePath({path:e,database:t});return Promise.resolve(n)}catch(e){return Promise.reject(e)}}async createNCConnection(e,t){try{await this.sqlite.createNCConnection({databasePath:e,version:t});let n=new Ne(e,!0,this.sqlite),r=`RO_${e})`;return this._connectionDict.set(r,n),Promise.resolve(n)}catch(e){return Promise.reject(e)}}async closeNCConnection(e){try{await this.sqlite.closeNCConnection({databasePath:e});let t=`RO_${e})`;return this._connectionDict.delete(t),Promise.resolve()}catch(e){return Promise.reject(e)}}async isNCConnection(e){let t={},n=`RO_${e})`;return t.result=this._connectionDict.has(n),Promise.resolve(t)}async retrieveNCConnection(e){if(this._connectionDict.has(e)){let t=`RO_${e})`,n=this._connectionDict.get(t);return n===void 0?Promise.reject(`Connection ${e} is undefined`):Promise.resolve(n)}else return Promise.reject(`Connection ${e} does not exist`)}async isNCDatabase(e){try{let t=await this.sqlite.isNCDatabase({databasePath:e});return Promise.resolve(t)}catch(e){return Promise.reject(e)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){let e=new Map;try{for(let t of this._connectionDict.keys()){let n=t.substring(3),r=t.substring(0,3)===`RO_`;await this.sqlite.closeConnection({database:n,readonly:r}),e.set(t,null)}for(let t of e.keys())this._connectionDict.delete(t);return Promise.resolve()}catch(e){return Promise.reject(e)}}async checkConnectionsConsistency(){try{let e=[...this._connectionDict.keys()],t=[],n=[];for(let r of e)t.push(r.substring(0,2)),n.push(r.substring(3));let r=await this.sqlite.checkConnectionsConsistency({dbNames:n,openModes:t});return r.result||(this._connectionDict=new Map),Promise.resolve(r)}catch(e){return this._connectionDict=new Map,Promise.reject(e)}}async importFromJson(e){try{let t=await this.sqlite.importFromJson({jsonstring:e});return Promise.resolve(t)}catch(e){return Promise.reject(e)}}async isJsonValid(e){try{let t=await this.sqlite.isJsonValid({jsonstring:e});return Promise.resolve(t)}catch(e){return Promise.reject(e)}}async copyFromAssets(e){let t=e??!0;try{return await this.sqlite.copyFromAssets({overwrite:t}),Promise.resolve()}catch(e){return Promise.reject(e)}}async getFromHTTPRequest(e,t){let n=t??!0;try{return await this.sqlite.getFromHTTPRequest({url:e,overwrite:n}),Promise.resolve()}catch(e){return Promise.reject(e)}}async isDatabaseEncrypted(e){e.endsWith(`.db`)&&(e=e.slice(0,-3));try{let t=await this.sqlite.isDatabaseEncrypted({database:e});return Promise.resolve(t)}catch(e){return Promise.reject(e)}}async isInConfigEncryption(){try{let e=await this.sqlite.isInConfigEncryption();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isInConfigBiometricAuth(){try{let e=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isDatabase(e){e.endsWith(`.db`)&&(e=e.slice(0,-3));try{let t=await this.sqlite.isDatabase({database:e});return Promise.resolve(t)}catch(e){return Promise.reject(e)}}async getDatabaseList(){try{let e=(await this.sqlite.getDatabaseList()).values;e.sort();let t={values:e};return Promise.resolve(t)}catch(e){return Promise.reject(e)}}async getMigratableDbList(e){let t=e||`default`;try{let e=await this.sqlite.getMigratableDbList({folderPath:t});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async addSQLiteSuffix(e,t){let n=e||`default`,r=t||[];try{let e=await this.sqlite.addSQLiteSuffix({folderPath:n,dbNameList:r});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async deleteOldDatabases(e,t){let n=e||`default`,r=t||[];try{let e=await this.sqlite.deleteOldDatabases({folderPath:n,dbNameList:r});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async moveDatabasesAndAddSuffix(e,t){let n=e||`default`,r=t||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:n,dbNameList:r})}},Ne=class{constructor(e,t,n){this.dbName=e,this.readonly=t,this.sqlite=n}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(e){return Promise.reject(e)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(e){return Promise.reject(e)}}async beginTransaction(){try{let e=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async commitTransaction(){try{let e=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async rollbackTransaction(){try{let e=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isTransactionActive(){try{let e=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async loadExtension(e){try{return await this.sqlite.loadExtension({database:this.dbName,path:e,readonly:this.readonly}),Promise.resolve()}catch(e){return Promise.reject(e)}}async enableLoadExtension(e){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:e,readonly:this.readonly}),Promise.resolve()}catch(e){return Promise.reject(e)}}async getUrl(){try{let e=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async getVersion(){try{let e=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async getTableList(){try{let e=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async execute(e,t=!0,n=!0){try{if(this.readonly)return Promise.reject(`not allowed in read-only mode`);{let r=await this.sqlite.execute({database:this.dbName,statements:e,transaction:t,readonly:!1,isSQL92:n});return Promise.resolve(r)}}catch(e){return Promise.reject(e)}}async query(e,t,n=!0){let r;try{return r=t&&t.length>0?await this.sqlite.query({database:this.dbName,statement:e,values:t,readonly:this.readonly,isSQL92:!0}):await this.sqlite.query({database:this.dbName,statement:e,values:[],readonly:this.readonly,isSQL92:n}),r=await this.reorderRows(r),Promise.resolve(r)}catch(e){return Promise.reject(e)}}async run(e,t,n=!0,r=`no`,i=!0){let a;try{return this.readonly?Promise.reject(`not allowed in read-only mode`):(a=t&&t.length>0?await this.sqlite.run({database:this.dbName,statement:e,values:t,transaction:n,readonly:!1,returnMode:r,isSQL92:!0}):await this.sqlite.run({database:this.dbName,statement:e,values:[],transaction:n,readonly:!1,returnMode:r,isSQL92:i}),a.changes=await this.reorderRows(a.changes),Promise.resolve(a))}catch(e){return Promise.reject(e)}}async executeSet(e,t=!0,n=`no`,r=!0){let i;try{return this.readonly?Promise.reject(`not allowed in read-only mode`):(i=await this.sqlite.executeSet({database:this.dbName,set:e,transaction:t,readonly:!1,returnMode:n,isSQL92:r}),i.changes=await this.reorderRows(i.changes),Promise.resolve(i))}catch(e){return Promise.reject(e)}}async isExists(){try{let e=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async isTable(e){try{let t=await this.sqlite.isTableExists({database:this.dbName,table:e,readonly:this.readonly});return Promise.resolve(t)}catch(e){return Promise.reject(e)}}async isDBOpen(){try{let e=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(e)}catch(e){return Promise.reject(e)}}async delete(){try{return this.readonly?Promise.reject(`not allowed in read-only mode`):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(e){return Promise.reject(e)}}async createSyncTable(){try{if(this.readonly)return Promise.reject(`not allowed in read-only mode`);{let e=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(e)}}catch(e){return Promise.reject(e)}}async setSyncDate(e){try{return this.readonly?Promise.reject(`not allowed in read-only mode`):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:e,readonly:!1}),Promise.resolve())}catch(e){return Promise.reject(e)}}async getSyncDate(){try{let e=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly}),t=``;return e.syncDate>0&&(t=new Date(e.syncDate*1e3).toISOString()),Promise.resolve(t)}catch(e){return Promise.reject(e)}}async exportToJson(e,t=!1){try{let n=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:e,readonly:this.readonly,encrypted:t});return Promise.resolve(n)}catch(e){return Promise.reject(e)}}async deleteExportedRows(){try{return this.readonly?Promise.reject(`not allowed in read-only mode`):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(e){return Promise.reject(e)}}async executeTransaction(e,t=!0){let n=0,r=!1;if(this.readonly)return Promise.reject(`not allowed in read-only mode`);if(await this.sqlite.beginTransaction({database:this.dbName}),r=await this.sqlite.isTransactionActive({database:this.dbName}),!r)return Promise.reject(`After Begin Transaction, no transaction active`);try{for(let r of e){if(typeof r!=`object`||!(`statement`in r))throw Error(`Error a task.statement must be provided`);if(`values`in r&&r.values&&r.values.length>0){let e=r.statement.toUpperCase().includes(`RETURNING`)?`all`:`no`,i=await this.sqlite.run({database:this.dbName,statement:r.statement,values:r.values,transaction:!1,readonly:!1,returnMode:e,isSQL92:t});if(i.changes.changes<0)throw Error(`Error in transaction method run `);n+=i.changes.changes}else{let e=await this.sqlite.execute({database:this.dbName,statements:r.statement,transaction:!1,readonly:!1});if(e.changes.changes<0)throw Error(`Error in transaction method execute `);n+=e.changes.changes}}let r=await this.sqlite.commitTransaction({database:this.dbName});n+=r.changes.changes;let i={changes:{changes:n}};return Promise.resolve(i)}catch(e){let t=e.message?e.message:e;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(t)}}async reorderRows(e){let t=e;if(e?.values&&typeof e.values[0]==`object`&&Object.keys(e.values[0]).includes(`ios_columns`)){let n=e.values[0].ios_columns,r=[];for(let t=1;t<e.values.length;t++){let i=e.values[t],a={};for(let e of n)a[e]=i[e];r.push(a)}t.values=r}return Promise.resolve(t)}},Pe=B(`CapacitorSQLite`,{web:()=>w(()=>import(`./B0pyCWQd.js`).then(e=>new e.CapacitorSQLiteWeb),[],import.meta.url),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite}),Fe=`i-ching`,Ie=`
...
`,U=null;function Le(e){return{id:e.id,createdAt:e.created_at,locale:e.locale,question:e.question,primaryNumber:e.primary_hexagram,relatingNumber:e.changed_hexagram??void 0,changingLines:JSON.parse(e.moving_lines),method:e.method??void 0,lines:JSON.parse(e.lines_json),coinRows:e.coin_rows_json?JSON.parse(e.coin_rows_json):void 0,note:e.note??void 0}}async function W(){return U||(U=await new Me(Pe).createConnection(Fe,!1,`no-encryption`,1,!1),await U.open(),await U.execute(Ie),U)}async function Re(e){let{value:t}=await V.get({key:ke});if(t===`true`)return;let n=await new je().loadAll();if(n.length===0){await V.set({key:ke,value:`true`});return}for(let t of n.reverse())await ze(e,t);typeof localStorage<`u`&&localStorage.removeItem(H),await V.set({key:ke,value:`true`})}async function ze(e,t){await e.run(`INSERT OR REPLACE INTO readings (
			id, created_at, locale, question, primary_hexagram, changed_hexagram,
			moving_lines, method, lines_json, coin_rows_json, note
		) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,[t.id,t.createdAt,t.locale??`uk`,t.question,t.primaryNumber,t.relatingNumber??null,JSON.stringify(t.changingLines),t.method??null,JSON.stringify(t.lines),t.coinRows?JSON.stringify(t.coinRows):null,t.note??null])}var Be=class{async ensureReady(){await Re(await W())}async loadAll(){return((await(await W()).query(`SELECT id, created_at, locale, question, primary_hexagram, changed_hexagram,
				moving_lines, method, lines_json, coin_rows_json, note
			FROM readings
			ORDER BY created_at DESC`)).values??[]).map(Le)}async save(e){await ze(await W(),e)}async deleteByIds(e){if(e.length===0)return;let t=await W(),n=e.map(()=>`?`).join(`, `);await t.run(`DELETE FROM readings WHERE id IN (${n})`,e)}},Ve=null;function G(){return Ve||=z.isNativePlatform()?new Be:new je,Ve}async function K(){await G().ensureReady()}async function He(){return await K(),G().loadAll()}async function Ue(e){await K(),await G().save(e)}async function We(e){await K(),await G().deleteByIds(e)}var Ge=new class{#e=p(m([]));get entries(){return s(this.#e)}set entries(e){r(this.#e,e,!0)}async load(){this.entries=await He()}async save(e){await Ue(e),this.entries=await He()}async deleteByIds(e){e.length!==0&&(await We(e),this.entries=await He())}},Ke=d(`<button><!></button>`);function qe(e,t){let r=y(t,`variant`,3,`secondary`),i=y(t,`primaryTone`,3,`solid`),a=y(t,`fullWidth`,3,!1),s=y(t,`type`,3,`button`),c=y(t,`disabled`,3,!1),l=y(t,`class`,3,``);var d=Ke();let f;S(u(d),()=>t.children),v(d),o(()=>{C(d,`type`,s()),C(d,`form`,t.form),d.disabled=c(),f=x(d,1,`btn ${l()??``}`,`svelte-1fzw96i`,f,{primary:r()===`primary`,"primary-soft":r()===`primary`&&i()===`soft`,secondary:r()===`secondary`,danger:r()===`danger`,"paid-panel":r()===`paid-panel`,"popup-close":r()===`popup-close`,text:r()===`text`,"full-width":a(),pressed:t.pressed===!0}),C(d,`aria-pressed`,t.pressed)}),n(`click`,d,function(...e){t.onclick?.apply(this,e)}),b(e,d)}f([`click`]);function Je(e){return document.body.appendChild(e),{destroy(){e.remove()}}}function Ye(){let e=document.activeElement;e instanceof HTMLElement&&e.blur()}function Xe(e,t,n){function r(){e()&&(t()(),requestAnimationFrame(Ye))}function i(){let e=n();if(e?.open){e.close();return}r()}function a(){r()}function o(e){e.preventDefault(),i()}return c(()=>{let t=n();t&&(e()&&!t.open?(t.showModal(),requestAnimationFrame(Ye)):!e()&&t.open&&t.close())}),{dismiss:i,handleDialogClose:a,handleCancel:o}}var Ze=d(`<div class="shell-toolbar svelte-1cozfid"><!></div>`),Qe=d(`<dialog class="fullscreen svelte-1cozfid" tabindex="-1"><header class="shell-header svelte-1cozfid"><h1 class="shell-title svelte-1cozfid"><!></h1> <!></header> <div class="shell-body svelte-1cozfid"><!></div> <div class="shell-close svelte-1cozfid"><!></div></dialog>`);function $e(n,a){i(a,!0);let l=Oe(),d=h(()=>a.closeLabel??l.t(`reading.helpClose`)),f=p(null),m=0,{dismiss:_,handleDialogClose:y,handleCancel:x}=Xe(()=>a.open,()=>a.onClose,()=>s(f));c(()=>{if(a.open)return m=window.scrollY,document.documentElement.classList.add(`scroll-locked`),document.body.style.position=`fixed`,document.body.style.top=`-${m}px`,document.body.style.left=`0`,document.body.style.right=`0`,document.body.style.width=`100%`,()=>{document.documentElement.classList.remove(`scroll-locked`),document.body.style.position=``,document.body.style.top=``,document.body.style.left=``,document.body.style.right=``,document.body.style.width=``,window.scrollTo(0,m)}});var w=Qe(),k=u(w),A=u(k),j=u(A),M=e=>{var t=E();S(O(t),()=>a.titleContent),b(e,t)},N=e=>{var t=re();o(()=>D(t,a.title)),b(e,t)};T(j,e=>{a.titleContent?e(M):e(N,-1)}),v(A);var ie=e(A,2),P=e=>{var t=Ze();S(u(t),()=>a.toolbar),v(t),b(e,t)};T(ie,e=>{a.toolbar&&e(P)}),v(k);var F=e(k,2);S(u(F),()=>a.children),v(F);var I=e(F,2);qe(u(I),{variant:`popup-close`,get onclick(){return _},children:(e,t)=>{g();var n=re();o(()=>D(n,s(d))),b(e,n)},$$slots:{default:!0}}),v(I),v(w),ee(w,e=>Je?.(e)),ne(w,e=>r(f,e),()=>s(f)),o(()=>{C(w,`aria-labelledby`,a.titleId),C(A,`id`,a.titleId)}),t(`close`,w,y),t(`cancel`,w,x),b(n,w),te()}var et=d(`<div class="popup-footer-actions svelte-1ao4s18"><!></div>`),tt=d(`<dialog tabindex="-1"><h3 class="popup-title svelte-1ao4s18"> </h3> <div><!></div> <footer><!> <!></footer></dialog>`);function nt(a,c){i(c,!0);let l=y(c,`size`,3,`default`),d=y(c,`variant`,3,`default`),f=y(c,`scrollable`,3,!1),m=y(c,`bodyClass`,3,``),_=Oe(),w=h(()=>c.closeLabel??_.t(`reading.helpClose`)),E=p(null),{dismiss:O,handleDialogClose:k,handleCancel:A}=Xe(()=>c.open,()=>c.onClose,()=>s(E));var j=tt();let M;var N=u(j),ie=u(N,!0);v(N);var P=e(N,2);S(u(P),()=>c.children),v(P);var F=e(P,2);let I;var ae=u(F);qe(ae,{variant:`popup-close`,get onclick(){return O},children:(e,t)=>{g();var n=re();o(()=>D(n,s(w))),b(e,n)},$$slots:{default:!0}});var L=e(ae,2),oe=e=>{var t=et();S(u(t),()=>c.footer),v(t),b(e,t)};T(L,e=>{c.footer&&e(oe)}),v(F),v(j),ee(j,e=>Je?.(e)),ne(j,e=>r(E,e),()=>s(E)),o(()=>{M=x(j,1,`popup svelte-1ao4s18`,null,M,{wide:l()===`wide`,paid:d()===`paid`,scrollable:f()}),C(j,`aria-labelledby`,c.titleId),C(N,`id`,c.titleId),D(ie,c.title),x(P,1,`popup-body ${m()??``}`,`svelte-1ao4s18`),I=x(F,1,`popup-footer svelte-1ao4s18`,null,I,{"has-actions":!!c.footer})}),t(`close`,j,k),t(`cancel`,j,A),n(`click`,j,e=>{e.target===s(E)&&O()}),b(a,j),te()}f([`click`]);var rt=d(`<span aria-hidden="true"></span>`);function it(e,t){let n=y(t,`direction`,3,`disclosure`);var r=rt();let i;o(()=>i=x(r,1,`chevron svelte-mzz43e`,null,i,{forward:n()===`forward`})),b(e,r)}var at=d(`<details><summary class="summary svelte-1po3ue0"><span> </span> <span class="summary-end svelte-1po3ue0"><!> <!></span></summary> <div class="body svelte-1po3ue0"><!></div></details>`);function ot(t,n){let r=y(n,`tone`,3,`neutral`),i=y(n,`titleColor`,3,`changing`);var a=at();let s;var c=u(a),d=u(c);let f;var p=u(d,!0);v(d);var m=e(d,2),h=u(m);S(h,()=>n.summaryEnd??l),it(e(h,2),{}),v(m),v(c);var g=e(c,2);S(u(g),()=>n.children??l),v(g),v(a),o(()=>{s=x(a,1,`panel svelte-1po3ue0`,null,s,{warning:r()===`warning`}),f=x(d,1,`summary-title svelte-1po3ue0`,null,f,{faint:i()===`faint`,muted:i()===`muted`}),D(p,n.title)}),b(t,a)}var st=d(`<legend><!></legend>`),ct=d(`<span><!></span>`);function lt(e,t){let n=y(t,`size`,3,`default`),r=y(t,`asLegend`,3,!1);var i=E(),a=O(i),s=e=>{var r=st();let i;S(u(r),()=>t.children),v(r),o(()=>i=x(r,1,`field-label svelte-mja3q9`,null,i,{compact:n()===`compact`,row:n()===`row`})),b(e,r)},c=e=>{var r=ct();let i;S(u(r),()=>t.children),v(r),o(()=>i=x(r,1,`field-label svelte-mja3q9`,null,i,{compact:n()===`compact`,row:n()===`row`})),b(e,r)};T(a,e=>{r()?e(s):e(c,-1)}),b(e,i)}var ut=d(`<button type="button"><!></button>`);function dt(e,t){let r=y(t,`expanded`,3,!1),i=y(t,`visible`,3,!0);var a=ut();let s;S(u(a),()=>t.children),v(a),o(()=>{s=x(a,1,`icon-btn svelte-hime8y`,null,s,{expanded:r(),visible:i()}),C(a,`aria-label`,t.label),C(a,`aria-expanded`,r()),C(a,`aria-haspopup`,t.haspopup),C(a,`title`,t.title??t.label)}),n(`click`,a,function(...e){t.onclick?.apply(this,e)}),b(e,a)}f([`click`]);var ft=d(`<button type="button" class="info-btn svelte-9slf2v">i</button>`);function pt(e,t){i(t,!0);var r=ft();o(()=>C(r,`aria-label`,t.label)),n(`mousedown`,r,e=>{e.preventDefault()}),n(`click`,r,e=>{e.preventDefault(),e.stopPropagation(),t.onclick(),e.currentTarget.blur()}),b(e,r),te()}f([`mousedown`,`click`]);var mt=d(`<button type="button" class="more-text-btn svelte-9vlb3d"><svg viewBox="0 0 16 16" aria-hidden="true" class="svelte-9vlb3d"><path d="M3 3.5h10M3 6.5h10M3 9.5h7" stroke="currentColor" stroke-width="1.15" fill="none"></path><path d="M9.5 11.5 11.5 13.5 13.5 11.5" stroke="currentColor" stroke-width="1.15" fill="none" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>`);function ht(e,t){i(t,!0);var r=mt();o(()=>{C(r,`aria-label`,t.label),C(r,`title`,t.label)}),n(`mousedown`,r,e=>{e.preventDefault()}),n(`click`,r,e=>{e.preventDefault(),e.stopPropagation(),t.onclick(),e.currentTarget.blur()}),b(e,r),te()}f([`mousedown`,`click`]);var gt;(function(e){e.AdPersonalization=`AD_PERSONALIZATION`,e.AdStorage=`AD_STORAGE`,e.AdUserData=`AD_USER_DATA`,e.AnalyticsStorage=`ANALYTICS_STORAGE`,e.FunctionalityStorage=`FUNCTIONALITY_STORAGE`,e.PersonalizationStorage=`PERSONALIZATION_STORAGE`})(gt||={});var _t;(function(e){e.Granted=`GRANTED`,e.Denied=`DENIED`})(_t||={});var vt=B(`FirebaseAnalytics`,{web:()=>w(()=>import(`./BZ589LDS.js`).then(e=>new e.FirebaseAnalyticsWeb),[],import.meta.url)});function yt(e,t){vt.logEvent({name:e,params:t}).catch(()=>{})}function bt(e,t){let n=t,r=!1,i=new IntersectionObserver(([e])=>{e?.isIntersecting&&!r&&(r=!0,yt(n.event,n.params))},{threshold:n.threshold??.5});return i.observe(e),{update(e){e.key!==n.key&&(r=!1),n=e},destroy(){i.disconnect()}}}var q;(function(e){e.Unimplemented=`UNIMPLEMENTED`,e.Unavailable=`UNAVAILABLE`})(q||={});var xt=class extends Error{constructor(e,t,n){super(e),this.message=e,this.code=t,this.data=n}},St=e=>e?.androidBridge?`android`:e?.webkit?.messageHandlers?.bridge?`ios`:`web`,Ct=e=>{let t=e.CapacitorCustomPlatform||null,n=e.Capacitor||{},r=n.Plugins=n.Plugins||{},i=()=>t===null?St(e):t.name,a=()=>i()!==`web`,o=e=>!!(l.get(e)?.platforms.has(i())||s(e)),s=e=>n.PluginHeaders?.find(t=>t.name===e),c=t=>e.console.error(t),l=new Map;return n.convertFileSrc||=e=>e,n.getPlatform=i,n.handleError=c,n.isNativePlatform=a,n.isPluginAvailable=o,n.registerPlugin=(e,a={})=>{let o=l.get(e);if(o)return console.warn(`Capacitor plugin "${e}" already registered. Cannot register plugins twice.`),o.proxy;let c=i(),u=s(e),d,f=async()=>(!d&&c in a?d=d=typeof a[c]==`function`?await a[c]():a[c]:t!==null&&!d&&`web`in a&&(d=d=typeof a.web==`function`?await a.web():a.web),d),p=(t,r)=>{if(u){let i=u?.methods.find(e=>r===e.name);if(i)return i.rtype===`promise`?t=>n.nativePromise(e,r.toString(),t):(t,i)=>n.nativeCallback(e,r.toString(),t,i);if(t)return t[r]?.bind(t)}else if(t)return t[r]?.bind(t);else throw new xt(`"${e}" plugin is not implemented on ${c}`,q.Unimplemented)},m=t=>{let n,r=(...r)=>{let i=f().then(i=>{let a=p(i,t);if(a){let e=a(...r);return n=e?.remove,e}else throw new xt(`"${e}.${t}()" is not implemented on ${c}`,q.Unimplemented)});return t===`addListener`&&(i.remove=async()=>n()),i};return r.toString=()=>`${t.toString()}() { [capacitor code] }`,Object.defineProperty(r,"name",{value:t,writable:!1,configurable:!1}),r},h=m(`addListener`),g=m(`removeListener`),_=(e,t)=>{let n=h({eventName:e},t),r=async()=>{g({eventName:e,callbackId:await n},t)},i=new Promise(e=>n.then(()=>e({remove:r})));return i.remove=async()=>{console.warn(`Using addListener() without 'await' is deprecated.`),await r()},i},v=new Proxy({},{get(e,t){switch(t){case`$$typeof`:return;case`toJSON`:return()=>({});case`addListener`:return u?_:h;case`removeListener`:return g;default:return m(t)}}});return r[e]=v,l.set(e,{name:e,proxy:v,platforms:new Set([...Object.keys(a),...u?[c]:[]])}),v},n.Exception=xt,n.DEBUG=!!n.DEBUG,n.isLoggingEnabled=!!n.isLoggingEnabled,n},J=(e=>e.Capacitor=Ct(e))(typeof globalThis<`u`?globalThis:typeof self<`u`?self:typeof window<`u`?window:typeof global<`u`?global:{}),Y=J.registerPlugin,X=class{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,t){let n=!1;this.listeners[e]||(this.listeners[e]=[],n=!0),this.listeners[e].push(t);let r=this.windowListeners[e];return r&&!r.registered&&this.addWindowListener(r),n&&this.sendRetainedArgumentsForEvent(e),Promise.resolve({remove:async()=>this.removeListener(e,t)})}async removeAllListeners(){this.listeners={};for(let e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,t,n){let r=this.listeners[e];if(!r){if(n){let n=this.retainedEventArguments[e];n||=[],n.push(t),this.retainedEventArguments[e]=n}return}r.forEach(e=>e(t))}hasListeners(e){return!!this.listeners[e]?.length}registerWindowListener(e,t){this.windowListeners[t]={registered:!1,windowEventName:e,pluginEventName:t,handler:e=>{this.notifyListeners(t,e)}}}unimplemented(e=`not implemented`){return new J.Exception(e,q.Unimplemented)}unavailable(e=`not available`){return new J.Exception(e,q.Unavailable)}async removeListener(e,t){let n=this.listeners[e];if(!n)return;let r=n.indexOf(t);this.listeners[e].splice(r,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){let t=this.retainedEventArguments[e];t&&(delete this.retainedEventArguments[e],t.forEach(t=>{this.notifyListeners(e,t)}))}},wt=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Tt=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent),Et=class extends X{async getCookies(){let e=document.cookie,t={};return e.split(`;`).forEach(e=>{if(e.length<=0)return;let[n,r]=e.replace(/=/,`CAP_COOKIE`).split(`CAP_COOKIE`);n=Tt(n).trim(),r=Tt(r).trim(),t[n]=r}),t}async setCookie(e){try{let t=wt(e.key),n=wt(e.value),r=e.expires?`; expires=${e.expires.replace(`expires=`,``)}`:``,i=(e.path||`/`).replace(`path=`,``),a=e.url!=null&&e.url.length>0?`domain=${e.url}`:``;document.cookie=`${t}=${n||``}${r}; path=${i}; ${a};`}catch(e){return Promise.reject(e)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(e){return Promise.reject(e)}}async clearCookies(){try{let e=document.cookie.split(`;`)||[];for(let t of e)document.cookie=t.replace(/^ +/,``).replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}};Y(`CapacitorCookies`,{web:()=>new Et});var Dt=async e=>new Promise((t,n)=>{let r=new FileReader;r.onload=()=>{let e=r.result;t(e.indexOf(`,`)>=0?e.split(`,`)[1]:e)},r.onerror=e=>n(e),r.readAsDataURL(e)}),Ot=(e={})=>{let t=Object.keys(e);return Object.keys(e).map(e=>e.toLocaleLowerCase()).reduce((n,r,i)=>(n[r]=e[t[i]],n),{})},kt=(e,t=!0)=>e?Object.entries(e).reduce((e,n)=>{let[r,i]=n,a,o;return Array.isArray(i)?(o=``,i.forEach(e=>{a=t?encodeURIComponent(e):e,o+=`${r}=${a}&`}),o.slice(0,-1)):(a=t?encodeURIComponent(i):i,o=`${r}=${a}`),`${e}&${o}`},``).substr(1):null,At=(e,t={})=>{let n=Object.assign({method:e.method||`GET`,headers:e.headers},t),r=Ot(e.headers)[`content-type`]||``;if(typeof e.data==`string`)n.body=e.data;else if(r.includes(`application/x-www-form-urlencoded`)){let t=new URLSearchParams;for(let[n,r]of Object.entries(e.data||{}))t.set(n,r);n.body=t.toString()}else if(r.includes(`multipart/form-data`)||e.data instanceof FormData){let t=new FormData;if(e.data instanceof FormData)e.data.forEach((e,n)=>{t.append(n,e)});else for(let n of Object.keys(e.data))t.append(n,e.data[n]);n.body=t;let r=new Headers(n.headers);r.delete(`content-type`),n.headers=r}else (r.includes(`application/json`)||typeof e.data==`object`)&&(n.body=JSON.stringify(e.data));return n},jt=class extends X{async request(e){let t=At(e,e.webFetchExtra),n=kt(e.params,e.shouldEncodeUrlParams),r=n?`${e.url}?${n}`:e.url,i=await fetch(r,t),a=i.headers.get(`content-type`)||``,{responseType:o=`text`}=i.ok?e:{};a.includes(`application/json`)&&(o=`json`);let s,c;switch(o){case`arraybuffer`:case`blob`:c=await i.blob(),s=await Dt(c);break;case`json`:s=await i.json();break;default:s=await i.text()}let l={};return i.headers.forEach((e,t)=>{l[t]=e}),{data:s,headers:l,status:i.status,url:i.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:`GET`}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:`POST`}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:`PUT`}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:`PATCH`}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:`DELETE`}))}};Y(`CapacitorHttp`,{web:()=>new jt});var Mt;(function(e){e.Dark=`DARK`,e.Light=`LIGHT`,e.Default=`DEFAULT`})(Mt||={});var Nt;(function(e){e.StatusBar=`StatusBar`,e.NavigationBar=`NavigationBar`})(Nt||={});var Pt=class extends X{async setStyle(){this.unavailable(`not available for web`)}async setAnimation(){this.unavailable(`not available for web`)}async show(){this.unavailable(`not available for web`)}async hide(){this.unavailable(`not available for web`)}};Y(`SystemBars`,{web:()=>new Pt});var Ft=class extends X{async write(e){if(typeof navigator>`u`||!navigator.clipboard)throw this.unavailable(`Clipboard API not available in this browser`);if(e.string!==void 0)await this.writeText(e.string);else if(e.url)await this.writeText(e.url);else if(e.image)if(typeof ClipboardItem<`u`)try{let t=await(await fetch(e.image)).blob(),n=new ClipboardItem({[t.type]:t});await navigator.clipboard.write([n])}catch{throw Error(`Failed to write image`)}else throw this.unavailable(`Writing images to the clipboard is not supported in this browser`);else throw Error(`Nothing to write`)}async read(){if(typeof navigator>`u`||!navigator.clipboard)throw this.unavailable(`Clipboard API not available in this browser`);if(typeof ClipboardItem<`u`)try{let e=await navigator.clipboard.read(),t=e[0].types[0],n=await e[0].getType(t);return{value:await this._getBlobData(n,t),type:t}}catch{return this.readText()}else return this.readText()}async readText(){if(typeof navigator>`u`||!navigator.clipboard||!navigator.clipboard.readText)throw this.unavailable(`Reading from clipboard not supported in this browser`);return{value:await navigator.clipboard.readText(),type:`text/plain`}}async writeText(e){if(typeof navigator>`u`||!navigator.clipboard||!navigator.clipboard.writeText)throw this.unavailable(`Writting to clipboard not supported in this browser`);await navigator.clipboard.writeText(e)}_getBlobData(e,t){return new Promise((n,r)=>{let i=new FileReader;t.includes(`image`)?i.readAsDataURL(e):i.readAsText(e),i.onloadend=()=>{let e=i.result;n(e)},i.onerror=e=>{r(e)}})}},It=Y(`Clipboard`,{web:()=>new Ft});async function Lt(e){try{return await It.write({string:e}),!0}catch{try{return await navigator.clipboard?.writeText(e),!0}catch{return!1}}}var Z;(function(e){e.Heavy=`HEAVY`,e.Medium=`MEDIUM`,e.Light=`LIGHT`})(Z||={});var Rt;(function(e){e.Success=`SUCCESS`,e.Warning=`WARNING`,e.Error=`ERROR`})(Rt||={});var zt=Y(`Haptics`,{web:()=>w(()=>import(`./BS4BxcoL.js`).then(e=>new e.HapticsWeb),[],import.meta.url)});async function Bt(){if(J.isNativePlatform())try{await zt.impact({style:Z.Light})}catch{}}async function Vt(){if(J.isNativePlatform())try{await zt.impact({style:Z.Heavy}),await zt.notification({type:Rt.Success})}catch{}}var Ht=Y(`Share`,{web:()=>w(()=>import(`./CwbXUkUs.js`).then(e=>new e.ShareWeb),[],import.meta.url)});async function Ut(e){try{return(await Ht.canShare()).value?(await Ht.share(e),!0):!1}catch(e){return e instanceof Error&&e.name===`AbortError`}}function Wt(e=Math.random){return e()<.5?2:3}function Gt(e){return e===3?`yang`:`yin`}function Kt(e=Math.random){let t=[Wt(e),Wt(e),Wt(e)],n=t.reduce((e,t)=>e+t,0);return{lines:[$t(n)],sum:n,coins:t}}function qt(e){return $t(e.reduce((e,t)=>e+t,0))}var Jt={6:[[2,2,2]],7:[[2,2,3],[2,3,2],[3,2,2]],8:[[2,3,3],[3,2,3],[3,3,2]],9:[[3,3,3]]};function Yt(e){return e.value===`yin`&&e.kind===`old`?6:e.value===`yang`&&e.kind===`young`?7:e.value===`yin`&&e.kind===`young`?8:9}function Xt(e,t=Math.random){let n=Jt[Yt(e)];return[...n[Math.floor(t()*n.length)]]}function Zt(e,t){let n=t?tn(t):Math.random;return e.map(e=>[...Xt(e,n)])}function Qt(e=Math.random){let t=[],n=[];for(let r=0;r<6;r++){let r=Kt(e);t.push(r.lines[0]),n.push([...r.coins])}return{lines:t,coinRows:n}}function $t(e){switch(e){case 6:return en(`yin`,`old`);case 7:return en(`yang`,`young`);case 8:return en(`yin`,`young`);case 9:return en(`yang`,`old`);default:throw Error(`Invalid coin sum: ${e}`)}}function en(e,t){return{value:e,kind:t,changing:t===`old`}}function tn(e){let t=nn(e);return()=>(t=t*1664525+1013904223>>>0,t/4294967296)}function nn(e){let t=2166136261;for(let n of e)t^=n.charCodeAt(0),t=Math.imul(t,16777619);return t>>>0}function rn(e){return e.coinRows?.length?e.coinRows.map(e=>[...e]):Zt(e.lines,e.id)}function an(e){let t=new Map;for(let n of e)t.set(n.primaryNumber,(t.get(n.primaryNumber)??0)+1);return t}function on(){return crypto.randomUUID()}function sn(e){let t=new Date(e);return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`}function cn(e,t){let n=[],r=new Map,i=new Map,a=new Map;for(let o of e){let e=new Date(o.createdAt),s=String(e.getFullYear()),c=`${s}-${e.getMonth()}`,l=sn(o.createdAt),u=r.get(s);u||(u={key:s,label:s,months:[]},r.set(s,u),n.push(u));let d=i.get(c);d||(d={key:c,label:e.toLocaleDateString(t,{month:`long`,year:`numeric`}),days:[]},i.set(c,d),u.months.push(d));let f=a.get(l);f||(f={key:l,label:e.toLocaleDateString(t,{weekday:`long`,day:`numeric`,month:`long`}),entries:[]},a.set(l,f),d.days.push(f)),f.entries.push(o)}return n}var ln=[`qian`,`kun`,`zhen`,`xun`,`kan`,`li`,`gen`,`dui`],un={kun:{id:`kun`,yangBits:[0,0,0],glyph:`☷`},zhen:{id:`zhen`,yangBits:[1,0,0],glyph:`☳`},xun:{id:`xun`,yangBits:[0,1,1],glyph:`☴`},kan:{id:`kan`,yangBits:[0,1,0],glyph:`☵`},li:{id:`li`,yangBits:[1,0,1],glyph:`☲`},gen:{id:`gen`,yangBits:[0,0,1],glyph:`☶`},dui:{id:`dui`,yangBits:[1,1,0],glyph:`☱`},qian:{id:`qian`,yangBits:[1,1,1],glyph:`☰`}},dn=Object.fromEntries(Object.values(un).map(e=>[e.yangBits.join(``),e.id]));function fn(e){return un[e].glyph}function pn(e){return un[e].yangBits}function mn(e,t,n){let r=`${e}${t}${n}`,i=dn[r];if(!i)throw Error(`Invalid trigram line pattern: ${r}`);return i}var hn=[2,24,7,19,15,36,46,12,16,51,40,54,62,55,32,34,8,3,29,60,39,63,48,5,45,17,47,58,31,49,28,43,23,27,4,41,52,22,18,26,35,21,64,38,56,30,50,14,20,42,59,61,53,37,57,9,11,25,6,10,33,13,44,1];function gn(e){return e.reduce((e,t,n)=>t.value===`yang`?e|1<<n:e,0)}function _n(e){return hn[gn(e)]}function vn(e){let t=Array.from({length:6},(t,n)=>e>>n&1);return{lower:mn(t[0],t[1],t[2]),upper:mn(t[3],t[4],t[5])}}function yn(e,t){let n=pn(e),r=pn(t);return hn[n[0]<<0|n[1]<<1|n[2]<<2|r[0]<<3|r[1]<<4|r[2]<<5]}function bn(e){for(let t=0;t<64;t++)if(hn[t]===e)return t;throw Error(`Unknown hexagram number: ${e}`)}function xn(e){return vn(bn(e))}function Sn(e){return Array.from({length:6},(t,n)=>e>>n&1?`yang`:`yin`)}function Cn(e){return Number.isInteger(e)&&e>=1&&e<=64}var wn=`.䷀.䷁.䷂.䷃.䷄.䷅.䷆.䷇.䷈.䷉.䷊.䷋.䷌.䷍.䷎.䷏.䷐.䷑.䷒.䷓.䷔.䷕.䷖.䷗.䷘.䷙.䷚.䷛.䷜.䷝.䷞.䷟.䷠.䷡.䷢.䷣.䷤.䷥.䷦.䷧.䷨.䷩.䷪.䷫.䷬.䷭.䷮.䷯.䷰.䷱.䷲.䷳.䷴.䷵.䷶.䷷.䷸.䷹.䷺.䷻.䷼.䷽.䷾.䷿`.split(`.`);function Tn(e){return e<1||e>64?``:wn[e]??``}var En=new Map;for(let e=0;e<64;e++){let t=hn[e],{lower:n,upper:r}=vn(e);En.set(t,{number:t,binary:e,lower:n,upper:r,glyph:Tn(t)})}function Dn(e){let t=En.get(e);if(!t)throw Error(`Unknown hexagram number: ${e}`);return t}var On=Object.assign({"../../data/hexagrams/01.json":{number:1,chinese:`乾`,pinyin:`qián`,lower:`qian`,upper:`qian`,locales:{uk:{name:`Творчість`,composition:`Небо над небом.`,reading:{scene:`Рух без зовнішньої межі.
...
Do not celebrate a bank you have not yet stepped on.`},judgment:`Before Completion. Success. The young fox has almost crossed, but wets its tail. Nothing is favorable.`,image:`Fire over water: before completion. Thus the noble person carefully distinguishes things and sets them in their places.`}}}}),kn={};for(let[e,t]of Object.entries(On))e.endsWith(`.json`)&&(kn[t.number]=t);function An(e){let t=kn[e];if(!t)throw Error(`Unknown hexagram number: ${e}`);return t}var jn=kn;function Mn(e,t){let n=An(e),r=Dn(e),i=n.locales[t]??n.locales.uk;return{number:r.number,chinese:n.chinese,pinyin:n.pinyin,upper:r.upper,lower:r.lower,...i}}function Nn(e){return Object.values(jn).sort((e,t)=>e.number-t.number).map(t=>Mn(t.number,e))}var Pn={en:Object.assign({"../../data/hexagrams_ext/en/01.json":()=>w(()=>import(`./BHzlnlYv.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/02.json":()=>w(()=>import(`./Dv_G4kbJ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/03.json":()=>w(()=>import(`./DBfuiDQK.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/04.json":()=>w(()=>import(`./UUu9qiCS.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/05.json":()=>w(()=>import(`./C7PPCIVa.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/06.json":()=>w(()=>import(`./BI0mToyF.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/07.json":()=>w(()=>import(`./Dnq3j7eu.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/08.json":()=>w(()=>import(`./GIyQuQ7M.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/09.json":()=>w(()=>import(`./DTocSb57.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/10.json":()=>w(()=>import(`./Bo4YfPT6.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/11.json":()=>w(()=>import(`./AxioKYds.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/12.json":()=>w(()=>import(`./D5D8rOPl.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/13.json":()=>w(()=>import(`./CzqolG-H.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/14.json":()=>w(()=>import(`./BnDVhOHp.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/15.json":()=>w(()=>import(`./CQ8O8bL_.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/16.json":()=>w(()=>import(`./CyKeGZaM.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/17.json":()=>w(()=>import(`./IcGpmETZ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/18.json":()=>w(()=>import(`./xx3UnuKM.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/19.json":()=>w(()=>import(`./C_oP6jR9.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/20.json":()=>w(()=>import(`./BQ_YL-vz.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/21.json":()=>w(()=>import(`./B3mS-_4F2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/22.json":()=>w(()=>import(`./DwQqNuNc2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/23.json":()=>w(()=>import(`./DFaThrY02.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/24.json":()=>w(()=>import(`./Cd4fcd7o2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/25.json":()=>w(()=>import(`./BbVkeYLh2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/26.json":()=>w(()=>import(`./DKCKO38-2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/27.json":()=>w(()=>import(`./B9FwEUlF2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/28.json":()=>w(()=>import(`./7kJ4T4lm2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/29.json":()=>w(()=>import(`./DmmzsGrp2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/30.json":()=>w(()=>import(`./Drk6W2Ss2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/31.json":()=>w(()=>import(`./BBDajprx2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/32.json":()=>w(()=>import(`./C4wf4Fiq2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/33.json":()=>w(()=>import(`./gn3OZsBy2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/34.json":()=>w(()=>import(`./D3lh2CGM2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/35.json":()=>w(()=>import(`./JkvwBP8v2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/36.json":()=>w(()=>import(`./CmIDuH2o2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/37.json":()=>w(()=>import(`./Goz605AN2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/38.json":()=>w(()=>import(`./Cu-xASLs2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/39.json":()=>w(()=>import(`./W4Z0jFhx2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/40.json":()=>w(()=>import(`./C0PGaapQ2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/41.json":()=>w(()=>import(`./TwN75Bfl2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/42.json":()=>w(()=>import(`./DiA-iTpV2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/43.json":()=>w(()=>import(`./DiGQ8-Ic2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/44.json":()=>w(()=>import(`./Bv82pQ0_2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/45.json":()=>w(()=>import(`./BbBnXpj_2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/46.json":()=>w(()=>import(`./BvSLF7d_2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/47.json":()=>w(()=>import(`./C9UgxXnQ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/48.json":()=>w(()=>import(`./QwZn6tm6.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/49.json":()=>w(()=>import(`./CJ5EZv4H.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/50.json":()=>w(()=>import(`./CsBrZIl4.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/51.json":()=>w(()=>import(`./DjYIBVpI.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/52.json":()=>w(()=>import(`./kgGcKcus.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/53.json":()=>w(()=>import(`./C_7ZiMa0.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/54.json":()=>w(()=>import(`./DezS6b2a.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/55.json":()=>w(()=>import(`./DU2meKPM.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/56.json":()=>w(()=>import(`./B2ngzTvT.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/57.json":()=>w(()=>import(`./DAROmjuA.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/58.json":()=>w(()=>import(`./HBsU41yG.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/59.json":()=>w(()=>import(`./c11faA18.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/60.json":()=>w(()=>import(`./4eL0V7AT.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/61.json":()=>w(()=>import(`./C9EuuhyQ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/62.json":()=>w(()=>import(`./Basa6JZL.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/63.json":()=>w(()=>import(`./DFbs94PZ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/64.json":()=>w(()=>import(`./h0OxS-eR.js`).then(e=>e.default),[],import.meta.url)}),uk:Object.assign({"../../data/hexagrams_ext/uk/01.json":()=>w(()=>import(`./Cxw7S4M5.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/02.json":()=>w(()=>import(`./cD7_9aRg.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/03.json":()=>w(()=>import(`./thBxEVtq.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/04.json":()=>w(()=>import(`./6j3uvqdC.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/05.json":()=>w(()=>import(`./BMJbzh5o.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/06.json":()=>w(()=>import(`./CMrilXpp.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/07.json":()=>w(()=>import(`./DioRZFrC.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/08.json":()=>w(()=>import(`./B8aeTwHJ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/09.json":()=>w(()=>import(`./CZDQUJI6.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/10.json":()=>w(()=>import(`./_pnI4yib.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/11.json":()=>w(()=>import(`./B2uiVHv_.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/12.json":()=>w(()=>import(`./DvUyTSr6.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/13.json":()=>w(()=>import(`./wC8PB-pB.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/14.json":()=>w(()=>import(`./3AL5YCnG.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/15.json":()=>w(()=>import(`./DYdB7Mmi.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/16.json":()=>w(()=>import(`./Cfsvja0c.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/17.json":()=>w(()=>import(`./CpyEe3bG.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/18.json":()=>w(()=>import(`./DFR3l2nz.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/19.json":()=>w(()=>import(`./kdcFWJBo.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/20.json":()=>w(()=>import(`./CLVzytv_.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/21.json":()=>w(()=>import(`./IThtfKJD2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/22.json":()=>w(()=>import(`./CVNTXJ-p2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/23.json":()=>w(()=>import(`./n4Qwt2rg2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/24.json":()=>w(()=>import(`./8SLnhDp12.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/25.json":()=>w(()=>import(`./C_A-uqS12.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/26.json":()=>w(()=>import(`./x3dIlr002.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/27.json":()=>w(()=>import(`./Bu1nYtNv2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/28.json":()=>w(()=>import(`./DKda-v9n2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/29.json":()=>w(()=>import(`./DsQe9XJg2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/30.json":()=>w(()=>import(`./DXUr_Pqy2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/31.json":()=>w(()=>import(`./CoBGU2TW2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/32.json":()=>w(()=>import(`./DxBELlEF2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/33.json":()=>w(()=>import(`./CPJi51Y02.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/34.json":()=>w(()=>import(`./oeJ-KDS12.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/35.json":()=>w(()=>import(`./B9748dD-2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/36.json":()=>w(()=>import(`./qT83b4lZ2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/37.json":()=>w(()=>import(`./DtFvq9eR2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/38.json":()=>w(()=>import(`./Boz_efHj2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/39.json":()=>w(()=>import(`./BOi3bV0K2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/40.json":()=>w(()=>import(`./3Nbf9ZR22.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/41.json":()=>w(()=>import(`./gLVp63oV2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/42.json":()=>w(()=>import(`./C2177myD2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/43.json":()=>w(()=>import(`./DuuodlNx2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/44.json":()=>w(()=>import(`./Ud-QL4GK2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/45.json":()=>w(()=>import(`./BsPaxKyk2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/46.json":()=>w(()=>import(`./CJk70Iuv2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/47.json":()=>w(()=>import(`./DD81QuLt.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/48.json":()=>w(()=>import(`./DSHYvz7Y.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/49.json":()=>w(()=>import(`./CFBPaHCK.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/50.json":()=>w(()=>import(`./DfYF_7oH.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/51.json":()=>w(()=>import(`./nfY4ncD-.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/52.json":()=>w(()=>import(`./0AEa2fzf.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/53.json":()=>w(()=>import(`./ColFGXE9.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/54.json":()=>w(()=>import(`./D1LgmyQF.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/55.json":()=>w(()=>import(`./B2rCitLA.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/56.json":()=>w(()=>import(`./n3uAzNj9.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/57.json":()=>w(()=>import(`./BJPDgtjE.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/58.json":()=>w(()=>import(`./jaFJEr5s.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/59.json":()=>w(()=>import(`./Ciip-WRx.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/60.json":()=>w(()=>import(`./CR_7Yywt.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/61.json":()=>w(()=>import(`./BNPudVqL.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/62.json":()=>w(()=>import(`./BVx2Ad7B.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/63.json":()=>w(()=>import(`./CSqbVdhv.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/64.json":()=>w(()=>import(`./CvBRFR7k.js`).then(e=>e.default),[],import.meta.url)})},Q={en:{},uk:{}},Fn={en:{},uk:{}};for(let e of[`en`,`uk`])for(let[t,n]of Object.entries(Pn[e])){let r=t.match(/\/(\d{2})\.json$/);r&&(Q[e][Number(r[1])]=n)}async function In(e,t){let n=Q[t][e]?t:`uk`,r=Q[n][e];return r?(Fn[n][e]??=await r(),Fn[n][e]):null}function Ln(e,t){return!!(Q[t][e]??Q.uk[e])}var Rn=B(`App`,{web:()=>w(()=>import(`./vfo0LBA6.js`).then(e=>new e.AppWeb),[],import.meta.url)}),zn;(function(e){e.Dark=`DARK`,e.Light=`LIGHT`,e.Default=`DEFAULT`})(zn||={});var Bn;(function(e){e.None=`NONE`,e.Slide=`SLIDE`,e.Fade=`FADE`})(Bn||={});var Vn=B(`StatusBar`),Hn=B(`TextZoom`,{ios:()=>w(()=>import(`./BaK5UjbC.js`).then(e=>new e.TextZoomIOS),[],import.meta.url)}),Un=16,Wn=null,Gn=null;function Kn(e){let t=document.documentElement,n=Math.round(e*100);t.style.fontSize=`${Un*e}px`,t.style.setProperty(`-webkit-text-size-adjust`,`${n}%`),t.style.setProperty(`text-size-adjust`,`${n}%`)}async function $(){if(z.isNativePlatform())try{let{value:e}=await Hn.getPreferred();if(!Number.isFinite(e)||e<=0)return;if(z.getPlatform()===`ios`){Kn(e);return}await Hn.set({value:e})}catch{}}function qn(){requestAnimationFrame(()=>{$()})}async function Jn(){await $(),setTimeout(()=>void $(),150),Wn?.remove(),Wn=await Rn.addListener(`appStateChange`,({isActive:e})=>{e&&qn()}),Gn=()=>{document.visibilityState===`visible`&&qn()},document.addEventListener(`visibilitychange`,Gn)}function Yn(){Wn?.remove(),Wn=null,Gn&&=(document.removeEventListener(`visibilitychange`,Gn),null)}var Xn=null,Zn=null;function Qn(){let e=document.querySelector(`meta[name="viewport"]`);e&&e.setAttribute(`content`,`width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, viewport-fit=cover, user-scalable=no`)}async function $n(e){if(z.isNativePlatform()){Qn(),z.getPlatform()===`ios`&&(Zn=()=>{Qn(),$()},window.addEventListener(`resize`,Zn)),await K(),await Jn();try{await Vn.setStyle({style:zn.Dark})}catch{}e&&(Xn?.remove(),Xn=await Rn.addListener(`backButton`,()=>{e()}))}}async function er(){await Bt()}async function tr(){await Vt()}function nr(){Zn&&=(window.removeEventListener(`resize`,Zn),null),Yn(),Xn?.remove(),Xn=null}export{k as $,Rt as A,lt as B,Gt as C,Kt as D,Wt as E,_t as F,qe as G,it as H,gt as I,Oe as J,Ge as K,ht as L,X as M,yt as N,Ut as O,bt as P,ae as Q,pt as R,cn as S,Qt as T,nt as U,ot as V,$e as W,se as X,fe as Y,ce as Z,ln as _,$ as a,rn as b,Nn as c,bn as d,yn as f,xn as g,Sn as h,nr as i,Lt as j,Z as k,Mn as l,_n as m,er as n,In as o,Cn as p,De as q,$n as r,Ln as s,tr as t,Tn as u,fn as v,qt as w,an as x,on as y,dt as z};