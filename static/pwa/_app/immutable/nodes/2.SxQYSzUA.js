import{A as e,B as t,C as n,D as r,E as i,H as a,I as o,J as s,N as c,O as l,P as u,R as d,S as f,T as p,U as m,V as h,W as g,X as _,Z as v,_ as y,a as b,b as x,c as S,d as C,f as w,g as T,l as E,o as D,q as O,r as k,s as A,t as j,u as M,v as N,w as P,x as F,y as I,z as L}from"../chunks/Dr4kgHLz.js";import{t as R}from"../chunks/CeXP-I4y.js";import"../chunks/xihTtKlq.js";import{Ct as z,Dt as B,Et as V,Ft as H,Mt as U,Nt as W,Pt as G,Tt as ee,a as te,bt as K,dt as ne,ht as q,i as J,jt as re,kt as Y,n as X,r as Z,t as Q,ut as ie,vt as ae,wt as oe,xt as se}from"../chunks/BoH0rz5k.js";import{t as ce}from"../chunks/C-Jy-vcj.js";function le(e=Math.random){return e()<.5?2:3}function ue(e){return e===3?`yang`:`yin`}function de(e=Math.random){let t=[le(e),le(e),le(e)],n=t.reduce((e,t)=>e+t,0);return{lines:[ve(n)],sum:n,coins:t}}function fe(e){return ve(e.reduce((e,t)=>e+t,0))}var pe={6:[[2,2,2]],7:[[2,2,3],[2,3,2],[3,2,2]],8:[[2,3,3],[3,2,3],[3,3,2]],9:[[3,3,3]]};function me(e){return e.value===`yin`&&e.kind===`old`?6:e.value===`yang`&&e.kind===`young`?7:e.value===`yin`&&e.kind===`young`?8:9}function he(e,t=Math.random){let n=pe[me(e)];return[...n[Math.floor(t()*n.length)]]}function ge(e,t){let n=t?be(t):Math.random;return e.map(e=>[...he(e,n)])}function _e(e=Math.random){let t=[],n=[];for(let r=0;r<6;r++){let r=de(e);t.push(r.lines[0]),n.push([...r.coins])}return{lines:t,coinRows:n}}function ve(e){switch(e){case 6:return ye(`yin`,`old`);case 7:return ye(`yang`,`young`);case 8:return ye(`yin`,`young`);case 9:return ye(`yang`,`old`);default:throw Error(`Invalid coin sum: ${e}`)}}function ye(e,t){return{value:e,kind:t,changing:t===`old`}}function be(e){let t=xe(e);return()=>(t=t*1664525+1013904223>>>0,t/4294967296)}function xe(e){let t=2166136261;for(let n of e)t^=n.charCodeAt(0),t=Math.imul(t,16777619);return t>>>0}var Se=n(`<line x1="11" y1="24" x2="37" y2="24" class="mark svelte-54bt2n"></line>`),Ce=n(`<line x1="11" y1="22" x2="19" y2="22" class="mark svelte-54bt2n"></line><line x1="29" y1="26" x2="37" y2="26" class="mark svelte-54bt2n"></line>`,1),we=f(`<div role="img"><div class="coin-spin-inner svelte-54bt2n"><svg viewBox="0 0 48 48" aria-hidden="true" class="svelte-54bt2n"><circle cx="24" cy="24" r="21" class="ring svelte-54bt2n"></circle><rect x="18.5" y="18.5" width="11" height="11" class="hole svelte-54bt2n" rx="0.5"></rect><!></svg></div></div>`);function Te(e,n){s(n,!0);let r=b(n,`empty`,3,!1),i=b(n,`spinning`,3,!1),a=Y(),o=g(()=>n.value?ue(n.value):null),u=g(()=>r()?a.t(`coins.pending`):l(o)===`yang`?a.t(`coins.yang`):a.t(`coins.yin`));var f=we();let p;var m=d(f),h=d(m),y=t(d(h),2),S=e=>{x(e,Se())},w=e=>{var t=Ce();_(),x(e,t)};N(y,e=>{l(o)===`yang`?e(S):l(o)===`yin`&&e(w,1)}),v(h),v(m),v(f),c(()=>{p=C(f,1,`coin-face svelte-54bt2n`,null,p,{yang:l(o)===`yang`,yin:l(o)===`yin`,empty:r(),spinning:i()}),E(f,`aria-label`,l(u))}),x(e,f),O()}var Ee=f(`<span class="bar svelte-g0r7if"></span>`),De=f(`<span class="bar svelte-g0r7if"></span> <span class="bar svelte-g0r7if"></span>`,1),Oe=f(`<div aria-hidden="true"><!></div>`);function ke(e,t){s(t,!0);let n=b(t,`compact`,3,!1);var r=Oe();let i;var a=d(r),o=e=>{x(e,Ee())},l=e=>{var t=De();_(2),x(e,t)};N(a,e=>{t.line.value===`yang`?e(o):e(l,-1)}),v(r),c(()=>i=C(r,1,`glyph svelte-g0r7if`,null,i,{compact:n(),yang:t.line.value===`yang`,yin:t.line.value===`yin`,changing:t.line.changing})),x(e,r),O()}var Ae=f(`<span class="glyph-placeholder svelte-ygslya" aria-hidden="true"></span>`),je=f(`<div><span> </span> <div class="coins svelte-ygslya"></div> <!></div>`),Me=f(`<div class="coin-grid svelte-ygslya"></div>`);function Ne(e,n){s(n,!0);let r=b(n,`lines`,19,()=>[]),i=b(n,`spinningLine`,3,null),a=b(n,`spinningCoin`,3,null),o=b(n,`revealedLines`,3,6),u=b(n,`activeLine`,3,null),f=Y(),p=[6,5,4,3,2,1];function m(e){return u()!==null&&e===u()?`building`:e<=r().length&&r()[e-1]!==void 0&&e<=o()?`complete`:`pending`}var h=Me();T(h,21,()=>p,y,(e,s)=>{let u=g(()=>n.lineCoins[l(s)-1]),f=g(()=>r()[l(s)-1]),p=g(()=>l(s)<=o()||i()!==null&&l(s)===i());var h=je();let _;var b=d(h);let S;var w=d(b,!0);v(b);var E=t(b,2);T(E,20,()=>[0,1,2],y,(e,t)=>{let n=g(()=>l(u)?.[t]),r=g(()=>i()===l(s)&&a()===t+1);{let t=g(()=>l(n)===void 0),i=g(()=>l(r)&&l(p));Te(e,{get value(){return l(n)},get empty(){return l(t)},get spinning(){return l(i)}})}}),v(E);var D=t(E,2),O=e=>{ke(e,{get line(){return l(f)}})},k=e=>{x(e,Ae())};N(D,e=>{l(f)&&l(s)<=o()?e(O):e(k,-1)}),v(h),c(e=>{_=C(h,1,`coin-row svelte-ygslya`,null,_,{visible:l(p)}),S=C(b,1,`line-label svelte-ygslya`,null,S,e),I(w,l(s))},[()=>({complete:m(l(s))===`complete`,building:m(l(s))===`building`})]),x(e,h)}),v(h),c(e=>E(h,`aria-label`,e),[()=>f.t(`coins.gridLabel`)]),x(e,h),O()}var Pe=[`qian`,`kun`,`zhen`,`xun`,`kan`,`li`,`gen`,`dui`],Fe={kun:{id:`kun`,yangBits:[0,0,0],glyph:`☷`},zhen:{id:`zhen`,yangBits:[1,0,0],glyph:`☳`},xun:{id:`xun`,yangBits:[0,1,1],glyph:`☴`},kan:{id:`kan`,yangBits:[0,1,0],glyph:`☵`},li:{id:`li`,yangBits:[1,0,1],glyph:`☲`},gen:{id:`gen`,yangBits:[0,0,1],glyph:`☶`},dui:{id:`dui`,yangBits:[1,1,0],glyph:`☱`},qian:{id:`qian`,yangBits:[1,1,1],glyph:`☰`}},Ie=Object.fromEntries(Object.values(Fe).map(e=>[e.yangBits.join(``),e.id]));function Le(e){return Fe[e].glyph}function Re(e){return Fe[e].yangBits}function ze(e,t,n){let r=`${e}${t}${n}`,i=Ie[r];if(!i)throw Error(`Invalid trigram line pattern: ${r}`);return i}var Be=[2,24,7,19,15,36,46,12,16,51,40,54,62,55,32,34,8,3,29,60,39,63,48,5,45,17,47,58,31,49,28,43,23,27,4,41,52,22,18,26,35,21,64,38,56,30,50,14,20,42,59,61,53,37,57,9,11,25,6,10,33,13,44,1];function Ve(e){return e.reduce((e,t,n)=>t.value===`yang`?e|1<<n:e,0)}function He(e){return Be[Ve(e)]}function Ue(e){let t=Array.from({length:6},(t,n)=>e>>n&1);return{lower:ze(t[0],t[1],t[2]),upper:ze(t[3],t[4],t[5])}}function We(e,t){let n=Re(e),r=Re(t);return Be[n[0]<<0|n[1]<<1|n[2]<<2|r[0]<<3|r[1]<<4|r[2]<<5]}function Ge(e){for(let t=0;t<64;t++)if(Be[t]===e)return t;throw Error(`Unknown hexagram number: ${e}`)}function Ke(e){return Ue(Ge(e))}function qe(e){return Array.from({length:6},(t,n)=>e>>n&1?`yang`:`yin`)}function Je(e){return Number.isInteger(e)&&e>=1&&e<=64}var Ye=`.䷀.䷁.䷂.䷃.䷄.䷅.䷆.䷇.䷈.䷉.䷊.䷋.䷌.䷍.䷎.䷏.䷐.䷑.䷒.䷓.䷔.䷕.䷖.䷗.䷘.䷙.䷚.䷛.䷜.䷝.䷞.䷟.䷠.䷡.䷢.䷣.䷤.䷥.䷦.䷧.䷨.䷩.䷪.䷫.䷬.䷭.䷮.䷯.䷰.䷱.䷲.䷳.䷴.䷵.䷶.䷷.䷸.䷹.䷺.䷻.䷼.䷽.䷾.䷿`.split(`.`);function Xe(e){return e<1||e>64?``:Ye[e]??``}var Ze=new Map;for(let e=0;e<64;e++){let t=Be[e],{lower:n,upper:r}=Ue(e);Ze.set(t,{number:t,binary:e,lower:n,upper:r,glyph:Xe(t)})}function Qe(e){let t=Ze.get(e);if(!t)throw Error(`Unknown hexagram number: ${e}`);return t}var $e=Object.assign({"../../data/hexagrams/01.json":{number:1,chinese:`乾`,pinyin:`qián`,lower:`qian`,upper:`qian`,locales:{uk:{name:`Творчість`,composition:`Небо над небом.`,reading:{scene:`Рух без зовнішньої межі.
...
Do not celebrate a bank you have not yet stepped on.`},judgment:`Before Completion. Success. The young fox has almost crossed, but wets its tail. Nothing is favorable.`,image:`Fire over water: before completion. Thus the noble person carefully distinguishes things and sets them in their places.`}}}}),et={};for(let[e,t]of Object.entries($e))e.endsWith(`.json`)&&(et[t.number]=t);function tt(e){let t=et[e];if(!t)throw Error(`Unknown hexagram number: ${e}`);return t}var nt=et;function $(e,t){let n=tt(e),r=Qe(e),i=n.locales[t]??n.locales.uk;return{number:r.number,chinese:n.chinese,pinyin:n.pinyin,upper:r.upper,lower:r.lower,...i}}function rt(e){return Object.values(nt).sort((e,t)=>e.number-t.number).map(t=>$(t.number,e))}var it={en:Object.assign({"../../data/hexagrams_ext/en/01.json":()=>j(()=>import(`../chunks/BHzlnlYv.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/02.json":()=>j(()=>import(`../chunks/Dv_G4kbJ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/03.json":()=>j(()=>import(`../chunks/DBfuiDQK.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/04.json":()=>j(()=>import(`../chunks/UUu9qiCS.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/05.json":()=>j(()=>import(`../chunks/C7PPCIVa.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/06.json":()=>j(()=>import(`../chunks/BI0mToyF.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/07.json":()=>j(()=>import(`../chunks/Dnq3j7eu.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/08.json":()=>j(()=>import(`../chunks/GIyQuQ7M.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/09.json":()=>j(()=>import(`../chunks/DTocSb57.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/10.json":()=>j(()=>import(`../chunks/Bo4YfPT6.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/11.json":()=>j(()=>import(`../chunks/AxioKYds.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/12.json":()=>j(()=>import(`../chunks/D5D8rOPl.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/13.json":()=>j(()=>import(`../chunks/CzqolG-H.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/14.json":()=>j(()=>import(`../chunks/BnDVhOHp.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/15.json":()=>j(()=>import(`../chunks/CQ8O8bL_.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/16.json":()=>j(()=>import(`../chunks/CyKeGZaM.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/17.json":()=>j(()=>import(`../chunks/IcGpmETZ2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/18.json":()=>j(()=>import(`../chunks/xx3UnuKM2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/19.json":()=>j(()=>import(`../chunks/C_oP6jR92.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/20.json":()=>j(()=>import(`../chunks/BQ_YL-vz2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/21.json":()=>j(()=>import(`../chunks/B3mS-_4F2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/22.json":()=>j(()=>import(`../chunks/DwQqNuNc2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/23.json":()=>j(()=>import(`../chunks/DFaThrY02.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/24.json":()=>j(()=>import(`../chunks/Cd4fcd7o2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/25.json":()=>j(()=>import(`../chunks/BbVkeYLh2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/26.json":()=>j(()=>import(`../chunks/DKCKO38-2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/27.json":()=>j(()=>import(`../chunks/B9FwEUlF2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/28.json":()=>j(()=>import(`../chunks/7kJ4T4lm2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/29.json":()=>j(()=>import(`../chunks/DmmzsGrp2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/30.json":()=>j(()=>import(`../chunks/Drk6W2Ss2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/31.json":()=>j(()=>import(`../chunks/BBDajprx2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/32.json":()=>j(()=>import(`../chunks/C4wf4Fiq2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/33.json":()=>j(()=>import(`../chunks/gn3OZsBy2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/34.json":()=>j(()=>import(`../chunks/D3lh2CGM2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/35.json":()=>j(()=>import(`../chunks/JkvwBP8v2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/36.json":()=>j(()=>import(`../chunks/CmIDuH2o2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/37.json":()=>j(()=>import(`../chunks/Goz605AN2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/38.json":()=>j(()=>import(`../chunks/Cu-xASLs2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/39.json":()=>j(()=>import(`../chunks/W4Z0jFhx2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/40.json":()=>j(()=>import(`../chunks/C0PGaapQ2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/41.json":()=>j(()=>import(`../chunks/TwN75Bfl2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/42.json":()=>j(()=>import(`../chunks/DiA-iTpV2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/43.json":()=>j(()=>import(`../chunks/DiGQ8-Ic.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/44.json":()=>j(()=>import(`../chunks/Bv82pQ0_.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/45.json":()=>j(()=>import(`../chunks/BbBnXpj_.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/46.json":()=>j(()=>import(`../chunks/BvSLF7d_.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/47.json":()=>j(()=>import(`../chunks/C9UgxXnQ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/48.json":()=>j(()=>import(`../chunks/QwZn6tm6.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/49.json":()=>j(()=>import(`../chunks/CJ5EZv4H.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/50.json":()=>j(()=>import(`../chunks/CsBrZIl4.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/51.json":()=>j(()=>import(`../chunks/DjYIBVpI.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/52.json":()=>j(()=>import(`../chunks/kgGcKcus.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/53.json":()=>j(()=>import(`../chunks/C_7ZiMa0.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/54.json":()=>j(()=>import(`../chunks/DezS6b2a.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/55.json":()=>j(()=>import(`../chunks/DU2meKPM.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/56.json":()=>j(()=>import(`../chunks/B2ngzTvT.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/57.json":()=>j(()=>import(`../chunks/DAROmjuA.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/58.json":()=>j(()=>import(`../chunks/HBsU41yG.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/59.json":()=>j(()=>import(`../chunks/c11faA18.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/60.json":()=>j(()=>import(`../chunks/4eL0V7AT.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/61.json":()=>j(()=>import(`../chunks/C9EuuhyQ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/62.json":()=>j(()=>import(`../chunks/Basa6JZL.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/63.json":()=>j(()=>import(`../chunks/DFbs94PZ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/en/64.json":()=>j(()=>import(`../chunks/h0OxS-eR.js`).then(e=>e.default),[],import.meta.url)}),uk:Object.assign({"../../data/hexagrams_ext/uk/01.json":()=>j(()=>import(`../chunks/Cxw7S4M5.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/02.json":()=>j(()=>import(`../chunks/cD7_9aRg.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/03.json":()=>j(()=>import(`../chunks/thBxEVtq.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/04.json":()=>j(()=>import(`../chunks/6j3uvqdC.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/05.json":()=>j(()=>import(`../chunks/BMJbzh5o.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/06.json":()=>j(()=>import(`../chunks/CMrilXpp.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/07.json":()=>j(()=>import(`../chunks/DioRZFrC.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/08.json":()=>j(()=>import(`../chunks/B8aeTwHJ.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/09.json":()=>j(()=>import(`../chunks/CZDQUJI6.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/10.json":()=>j(()=>import(`../chunks/_pnI4yib.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/11.json":()=>j(()=>import(`../chunks/B2uiVHv_.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/12.json":()=>j(()=>import(`../chunks/DvUyTSr6.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/13.json":()=>j(()=>import(`../chunks/wC8PB-pB.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/14.json":()=>j(()=>import(`../chunks/3AL5YCnG.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/15.json":()=>j(()=>import(`../chunks/DYdB7Mmi.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/16.json":()=>j(()=>import(`../chunks/Cfsvja0c.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/17.json":()=>j(()=>import(`../chunks/CpyEe3bG2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/18.json":()=>j(()=>import(`../chunks/DFR3l2nz2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/19.json":()=>j(()=>import(`../chunks/kdcFWJBo2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/20.json":()=>j(()=>import(`../chunks/CLVzytv_2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/21.json":()=>j(()=>import(`../chunks/IThtfKJD2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/22.json":()=>j(()=>import(`../chunks/CVNTXJ-p2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/23.json":()=>j(()=>import(`../chunks/n4Qwt2rg2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/24.json":()=>j(()=>import(`../chunks/8SLnhDp12.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/25.json":()=>j(()=>import(`../chunks/C_A-uqS12.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/26.json":()=>j(()=>import(`../chunks/x3dIlr002.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/27.json":()=>j(()=>import(`../chunks/Bu1nYtNv2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/28.json":()=>j(()=>import(`../chunks/DKda-v9n2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/29.json":()=>j(()=>import(`../chunks/DsQe9XJg2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/30.json":()=>j(()=>import(`../chunks/DXUr_Pqy2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/31.json":()=>j(()=>import(`../chunks/CoBGU2TW2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/32.json":()=>j(()=>import(`../chunks/DxBELlEF2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/33.json":()=>j(()=>import(`../chunks/CPJi51Y02.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/34.json":()=>j(()=>import(`../chunks/oeJ-KDS12.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/35.json":()=>j(()=>import(`../chunks/B9748dD-2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/36.json":()=>j(()=>import(`../chunks/qT83b4lZ2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/37.json":()=>j(()=>import(`../chunks/DtFvq9eR2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/38.json":()=>j(()=>import(`../chunks/Boz_efHj2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/39.json":()=>j(()=>import(`../chunks/BOi3bV0K2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/40.json":()=>j(()=>import(`../chunks/3Nbf9ZR22.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/41.json":()=>j(()=>import(`../chunks/gLVp63oV2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/42.json":()=>j(()=>import(`../chunks/C2177myD2.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/43.json":()=>j(()=>import(`../chunks/DuuodlNx.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/44.json":()=>j(()=>import(`../chunks/Ud-QL4GK.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/45.json":()=>j(()=>import(`../chunks/BsPaxKyk.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/46.json":()=>j(()=>import(`../chunks/CJk70Iuv.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/47.json":()=>j(()=>import(`../chunks/DD81QuLt.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/48.json":()=>j(()=>import(`../chunks/DSHYvz7Y.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/49.json":()=>j(()=>import(`../chunks/CFBPaHCK.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/50.json":()=>j(()=>import(`../chunks/DfYF_7oH.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/51.json":()=>j(()=>import(`../chunks/nfY4ncD-.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/52.json":()=>j(()=>import(`../chunks/0AEa2fzf.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/53.json":()=>j(()=>import(`../chunks/ColFGXE9.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/54.json":()=>j(()=>import(`../chunks/D1LgmyQF.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/55.json":()=>j(()=>import(`../chunks/B2rCitLA.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/56.json":()=>j(()=>import(`../chunks/n3uAzNj9.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/57.json":()=>j(()=>import(`../chunks/BJPDgtjE.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/58.json":()=>j(()=>import(`../chunks/jaFJEr5s.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/59.json":()=>j(()=>import(`../chunks/Ciip-WRx.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/60.json":()=>j(()=>import(`../chunks/CR_7Yywt.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/61.json":()=>j(()=>import(`../chunks/BNPudVqL.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/62.json":()=>j(()=>import(`../chunks/BVx2Ad7B.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/63.json":()=>j(()=>import(`../chunks/CSqbVdhv.js`).then(e=>e.default),[],import.meta.url),"../../data/hexagrams_ext/uk/64.json":()=>j(()=>import(`../chunks/CvBRFR7k.js`).then(e=>e.default),[],import.meta.url)})},at={en:{},uk:{}},ot={en:{},uk:{}};for(let e of[`en`,`uk`])for(let[t,n]of Object.entries(it[e])){let r=t.match(/\/(\d{2})\.json$/);r&&(at[e][Number(r[1])]=n)}async function st(e,t){let n=at[t][e]?t:`uk`,r=at[n][e];return r?(ot[n][e]??=await r(),ot[n][e]):null}function ct(e,t){return!!(at[t][e]??at.uk[e])}var lt=f(`<span><span class="glyph svelte-16fr6kw" aria-hidden="true"> </span></span>`);function ut(e,t){s(t,!0);let n=b(t,`compact`,3,!1),r=g(()=>Xe(t.number));var i=lt();let a;var o=d(i),u=d(o,!0);v(o),v(i),c(()=>{a=C(i,1,`hex-font-icon svelte-16fr6kw`,null,a,{compact:n()}),E(i,`role`,t.label?`img`:void 0),E(i,`aria-label`,t.label),E(i,`aria-hidden`,t.label?void 0:!0),I(u,l(r))}),x(e,i),O()}var dt=f(`<div><button class="coin-pick-btn yin svelte-g7jscb"><svg viewBox="0 0 48 48" aria-hidden="true" class="svelte-g7jscb"><circle cx="24" cy="24" r="21" class="ring svelte-g7jscb"></circle><rect x="18.5" y="18.5" width="11" height="11" rx="0.5" class="hole svelte-g7jscb"></rect><line x1="11" y1="22" x2="19" y2="22" class="mark svelte-g7jscb"></line><line x1="29" y1="26" x2="37" y2="26" class="mark svelte-g7jscb"></line></svg></button> <button class="coin-pick-btn yang svelte-g7jscb"><svg viewBox="0 0 48 48" aria-hidden="true" class="svelte-g7jscb"><circle cx="24" cy="24" r="21" class="ring svelte-g7jscb"></circle><rect x="18.5" y="18.5" width="11" height="11" rx="0.5" class="hole svelte-g7jscb"></rect><line x1="11" y1="24" x2="37" y2="24" class="mark svelte-g7jscb"></line></svg></button></div>`),ft=f(`<button class="primary-btn toss-action svelte-g7jscb"> </button>`),pt=f(`<p class="status svelte-g7jscb"> </p>`),mt=f(`<section><!> <!></section>`);function ht(e,n){s(n,!0);let r=b(n,`immersive`,3,!1),a=Y(),o=g(()=>n.tossMode===`single`?a.t(`flow.tossSingle`):a.t(`flow.tossLine`));var u=mt();let f;var p=d(u);{let e=g(()=>n.step===`reading`?null:n.spinningLine),t=g(()=>n.step===`reading`?null:n.spinningCoin),r=g(()=>n.step===`reading`?6:n.coinGridRevealed),i=g(()=>n.step===`reading`?null:n.activeLine);Ne(p,{get lineCoins(){return n.lineCoins},get lines(){return n.lines},get spinningLine(){return l(e)},get spinningCoin(){return l(t)},get revealedLines(){return l(r)},get activeLine(){return l(i)}})}var m=t(p,2),h=e=>{var r=F(),s=L(r),u=e=>{var r=F(),o=L(r),s=e=>{var r=dt();let o;var s=d(r),l=t(s,2);v(r),c((e,t)=>{o=C(r,1,`coin-picker svelte-g7jscb`,null,o,{"coin-picker--disabled":n.tossing}),s.disabled=n.tossing,E(s,`aria-label`,e),l.disabled=n.tossing,E(l,`aria-label`,t)},[()=>a.t(`coins.yin`),()=>a.t(`coins.yang`)]),i(`click`,s,()=>n.onRealCoin?.(2)),i(`click`,l,()=>n.onRealCoin?.(3)),x(e,r)};N(o,e=>{n.lines.length<6&&e(s)}),x(e,r)},f=e=>{var t=F(),r=L(t),a=e=>{var t=ft(),r=d(t,!0);v(t),c(()=>{t.disabled=n.tossing,I(r,l(o))}),i(`click`,t,function(...e){n.onTossNext?.apply(this,e)}),x(e,t)};N(r,e=>{n.lines.length<6&&e(a)}),x(e,t)},p=e=>{var t=pt(),n=d(t,!0);v(t),c(e=>I(n,e),[()=>a.t(`flow.tossing`)]),x(e,t)};N(s,e=>{n.tossMode===`real`?e(u):n.tossMode===`all`?e(p,-1):e(f,1)}),x(e,r)};N(m,e=>{n.step===`toss`&&e(h)}),v(u),c(()=>f=C(u,1,`step cast-step svelte-g7jscb`,null,f,{"cast-step--immersive":r()})),x(e,u),O()}p([`click`]);function gt(e){return e.coinRows?.length?e.coinRows.map(e=>[...e]):ge(e.lines,e.id)}function _t(e){let t=new Map;for(let n of e)t.set(n.primaryNumber,(t.get(n.primaryNumber)??0)+1);return t}function vt(){return crypto.randomUUID()}function yt(e){let t=new Date(e);return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`}function bt(e,t){let n=[],r=new Map,i=new Map,a=new Map;for(let o of e){let e=new Date(o.createdAt),s=String(e.getFullYear()),c=`${s}-${e.getMonth()}`,l=yt(o.createdAt),u=r.get(s);u||(u={key:s,label:s,months:[]},r.set(s,u),n.push(u));let d=i.get(c);d||(d={key:c,label:e.toLocaleDateString(t,{month:`long`,year:`numeric`}),days:[]},i.set(c,d),u.months.push(d));let f=a.get(l);f||(f={key:l,label:e.toLocaleDateString(t,{weekday:`long`,day:`numeric`,month:`long`}),entries:[]},a.set(l,f),d.days.push(f)),f.entries.push(o)}return n}function xt(e){return e.split(/\n\s*\n/).map(e=>e.trim()).filter(Boolean)}var St=f(`<p class="svelte-1moqyhz"> </p>`),Ct=f(`<p class="svelte-1moqyhz">&nbsp;</p>`),wt=f(`<div class="help-body svelte-1moqyhz"><!></div>`);function Tt(e,t){s(t,!0);let n=g(()=>xt(t.body));V(e,{get open(){return t.open},get title(){return t.title},get onClose(){return t.onClose},get closeLabel(){return t.closeLabel},children:e=>{var t=wt(),r=d(t),i=e=>{var t=F();T(L(t),17,()=>l(n),y,(e,t)=>{var n=St(),r=d(n,!0);v(n),c(()=>I(r,l(t))),x(e,n)}),x(e,t)},a=e=>{x(e,Ct())};N(r,e=>{l(n).length>0?e(i):e(a,-1)}),v(t),x(e,t)},$$slots:{default:!0}}),O()}function Et(e,t){return new Date(e).toLocaleTimeString(t,{hour:`2-digit`,minute:`2-digit`})}function Dt(e){return e.relatingNumber?`${e.primaryNumber} -> ${e.relatingNumber}`:String(e.primaryNumber)}function Ot(e,t){if(!e.length)return``;let n=bt(e,t),r=``;for(let e of n)for(let n of e.months)for(let e of n.days){r+=`## ${e.label}\n\n`;for(let n of e.entries){let e=Et(n.createdAt,t),i=n.question.trim()||`—`;r+=`${e} ${i}\n`,r+=`${Dt(n)}\n\n`}}return r.trimEnd()}function kt(){let e=new Date,t=e=>String(e).padStart(2,`0`);return`iching-archive-${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}.md`}var At=f(`<div class="export-preview svelte-1f1b3r"><div class="export-actions svelte-1f1b3r"><!> <!></div> <pre class="export-text svelte-1f1b3r"> </pre></div>`),jt=f(`<!> <!>`,1);function Mt(e,n){s(n,!0);let r=Y(),i=g(()=>W(r.locale)),o=m(!1),u=m(``),f=m(``),p=m(!1);function h(){n.onClose(),a(p,!1)}async function y(){if(!n.journal.length)return;let e=Ot(n.journal,l(i)),t=kt();J(`archive_exported`,{entries:n.journal.length}),n.onClose(),!await q({title:t,text:e})&&(a(u,e,!0),a(f,t,!0),a(o,!0),a(p,!1))}function b(){let e=new Blob([l(u)],{type:`text/plain; charset=utf-8`}),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=l(f),document.body.appendChild(n),n.click(),setTimeout(()=>{URL.revokeObjectURL(t),n.remove()},2e3)}async function S(){try{await ae(l(u)),a(p,!0),setTimeout(()=>a(p,!1),2e3)}catch{}}var C=jt(),w=L(C);{let e=e=>{},t=e=>{{let t=g(()=>n.journal.length===0);H(e,{variant:`primary`,get disabled(){return l(t)},onclick:()=>void y(),children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`journal.exportAction`)]),x(e,n)},$$slots:{default:!0}})}},i=g(()=>r.t(`journal.exportTitle`));V(w,{get open(){return n.open},get title(){return l(i)},titleId:`journal-export-title`,onClose:h,children:e,footer:t,$$slots:{default:!0,footer:!0}})}var T=t(w,2);{let e=e=>{var n=At(),i=d(n),a=d(i);H(a,{variant:`secondary`,onclick:b,children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`journal.exportDownload`)]),x(e,n)},$$slots:{default:!0}}),H(t(a,2),{variant:`secondary`,onclick:()=>void S(),children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>l(p)?r.t(`journal.exportCopied`):r.t(`journal.exportCopy`)]),x(e,n)},$$slots:{default:!0}}),v(i);var o=t(i,2),s=d(o,!0);v(o),v(n),c(()=>I(s,l(u))),x(e,n)},n=g(()=>l(f)||r.t(`journal.exportShare`));B(T,{get open(){return l(o)},get title(){return l(n)},titleId:`journal-export-preview-title`,onClose:()=>a(o,!1),children:e,$$slots:{default:!0}})}x(e,C),O()}var Nt=f(`<p class="journal-archive__empty"> </p>`),Pt=f(`<li><button type="button"><span class="journal-archive__head"><span> </span> <time class="journal-archive__time"> </time></span> <span class="journal-archive__hex"> </span></button></li>`),Ft=f(`<!> <ul class="journal-archive__list"></ul>`,1);function It(e,n){s(n,!0);let r=Y(),o=g(()=>W(r.locale)),f=m(h(new Set)),p=m(!1),y=g(()=>l(f).size),b=g(()=>n.journal.length>0&&l(y)===n.journal.length);function S(){a(f,new Set,!0),a(p,!1),n.onClose()}u(()=>{n.open&&(a(f,new Set,!0),a(p,!1))});function w(e){return new Date(e).toLocaleString(l(o),{day:`numeric`,month:`short`,hour:`2-digit`,minute:`2-digit`})}function D(e){let t=$(e.primaryNumber,r.locale),n=e.relatingNumber?$(e.relatingNumber,r.locale):null;return n?`${t.number} ${t.name} → ${n.number} ${n.name}`:`${t.number} ${t.name}`}function k(e){let t=new Set(l(f));t.has(e)?t.delete(e):t.add(e),a(f,t,!0)}function A(){a(f,l(b)?new Set:new Set(n.journal.map(e=>e.id)),!0)}async function j(){if(!(l(y)===0||l(p))){a(p,!0);try{await n.onDelete([...l(f)]),a(f,new Set,!0)}finally{a(p,!1)}}}{let a=e=>{var a=F(),o=L(a),s=e=>{var t=Nt(),n=d(t,!0);v(t),c(e=>I(n,e),[()=>r.t(`profile.archiveEmpty`)]),x(e,t)},u=e=>{var a=Ft(),o=L(a);H(o,{variant:`text`,fullWidth:!0,get pressed(){return l(b)},class:`journal-archive__select-all`,onclick:A,children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`profile.selectAll`)]),x(e,n)},$$slots:{default:!0}});var s=t(o,2);T(s,21,()=>n.journal,e=>e.id,(e,n)=>{var r=Pt(),a=d(r);let o;var s=d(a),u=d(s);let p;var m=d(u,!0);v(u);var h=t(u,2),g=d(h,!0);v(h),v(s);var _=t(s,2),y=d(_,!0);v(_),v(a),v(r),c((e,t,r,i,s,c)=>{o=C(a,1,`journal-archive__entry`,null,o,e),E(a,`aria-pressed`,t),p=C(u,1,`journal-archive__q`,null,p,r),I(m,i),E(h,`datetime`,l(n).createdAt),I(g,s),I(y,c)},[()=>({active:l(f).has(l(n).id)}),()=>l(f).has(l(n).id),()=>({"journal-archive__q--empty":!l(n).question.trim()}),()=>l(n).question.trim()||`—`,()=>w(l(n).createdAt),()=>D(l(n))]),i(`click`,a,()=>k(l(n).id)),x(e,r)}),v(s),x(e,a)};N(o,e=>{n.journal.length===0?e(s):e(u,-1)}),x(e,a)},o=e=>{{let t=g(()=>l(y)===0||l(p)||n.journal.length===0);H(e,{variant:`danger`,get disabled(){return l(t)},onclick:()=>void j(),children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`profile.deleteSelected`,{count:l(y)})]),x(e,n)},$$slots:{default:!0}})}},s=g(()=>r.t(`profile.archiveTitle`));V(e,{get open(){return n.open},get title(){return l(s)},titleId:`journal-archive-popup`,bodyClass:`journal-archive`,scrollable:!0,onClose:S,children:a,footer:o,$$slots:{default:!0,footer:!0}})}O()}p([`click`]);var Lt=f(`<span class="hex-answer svelte-1kqe4l6"><span class="hex-answer__num svelte-1kqe4l6"> </span> <!> <span class="hex-answer__name svelte-1kqe4l6"> </span></span>`);function Rt(e,n){s(n,!0);var r=Lt(),i=d(r),a=d(i,!0);v(i);var o=t(i,2);ut(o,{get number(){return n.hexagram.number},get label(){return n.hexagram.name},compact:!0});var l=t(o,2),u=d(l,!0);v(l),v(r),c(()=>{I(a,n.hexagram.number),I(u,n.hexagram.name)}),x(e,r),O()}var zt=f(`<span class="entry-arrow svelte-1kq55en" aria-hidden="true">→</span> <!>`,1),Bt=f(`<button type="button"><div class="entry-head svelte-1kq55en"><span> </span> <time class="entry-time svelte-1kq55en"> </time></div> <span class="entry-answer svelte-1kq55en"><!> <!></span></button>`);function Vt(e,n){s(n,!0);let r=b(n,`active`,3,!1),a=Y(),o=g(()=>W(a.locale)),u=g(()=>$(n.entry.primaryNumber,a.locale)),f=g(()=>n.entry.relatingNumber?$(n.entry.relatingNumber,a.locale):null),p=g(()=>new Date(n.entry.createdAt).toLocaleTimeString(l(o),{hour:`2-digit`,minute:`2-digit`}));var m=Bt();let h;var _=d(m),y=d(_);let S;var w=d(y,!0);v(y);var T=t(y,2),D=d(T,!0);v(T),v(_);var k=t(_,2),A=d(k);Rt(A,{get hexagram(){return l(u)}});var j=t(A,2),M=e=>{var n=zt();Rt(t(L(n),2),{get hexagram(){return l(f)}}),x(e,n)};N(j,e=>{l(f)&&e(M)}),v(k),v(m),c((e,t,i)=>{h=C(m,1,`entry-btn svelte-1kq55en`,null,h,{active:r()}),E(m,`aria-label`,e),S=C(y,1,`entry-q svelte-1kq55en`,null,S,t),I(w,i),E(T,`datetime`,n.entry.createdAt),I(D,l(p))},[()=>a.t(`journal.openEntry`),()=>({"entry-q--empty":!n.entry.question.trim()}),()=>n.entry.question.trim()||`—`]),i(`click`,m,()=>n.onSelect(n.entry)),x(e,m),O()}p([`click`]);var Ht=f(`<li class="svelte-ogww31"><!></li>`),Ut=f(`<section class="group-day svelte-ogww31"><h5 class="group-day-label svelte-ogww31"> </h5> <ul class="entries svelte-ogww31"></ul></section>`),Wt=f(`<section class="group-month svelte-ogww31"><h4 class="group-month-label svelte-ogww31"> </h4> <!></section>`),Gt=f(`<section class="group-year svelte-ogww31"><h3 class="group-year-label svelte-ogww31"> </h3> <!></section>`),Kt=f(`<div class="entries-grouped svelte-ogww31"></div>`);function qt(e,n){let r=b(n,`activeCastingId`,3,null);var i=Kt();T(i,21,()=>n.grouped,e=>e.key,(e,i)=>{var a=Gt(),o=d(a),s=d(o,!0);v(o),T(t(o,2),17,()=>l(i).months,e=>e.key,(e,i)=>{var a=Wt(),o=d(a),s=d(o,!0);v(o),T(t(o,2),17,()=>l(i).days,e=>e.key,(e,i)=>{var a=Ut(),o=d(a),s=d(o,!0);v(o);var u=t(o,2);T(u,21,()=>l(i).entries,e=>e.id,(e,t)=>{var i=Ht(),a=d(i);{let e=g(()=>r()===l(t).id);Vt(a,{get entry(){return l(t)},get active(){return l(e)},get onSelect(){return n.onEntrySelect}})}v(i),x(e,i)}),v(u),v(a),c(()=>{E(a,`aria-labelledby`,`journal-day-${l(i).key??``}`),E(o,`id`,`journal-day-${l(i).key??``}`),I(s,l(i).label)}),x(e,a)}),v(a),c(()=>{E(a,`aria-labelledby`,`journal-month-${l(i).key??``}`),E(o,`id`,`journal-month-${l(i).key??``}`),I(s,l(i).label)}),x(e,a)}),v(a),c(()=>{E(a,`aria-labelledby`,`journal-year-${l(i).key??``}`),E(o,`id`,`journal-year-${l(i).key??``}`),I(s,l(i).label)}),x(e,a)}),v(i),x(e,i)}var Jt=f(`<li class="svelte-1w1m5at"><button type="button"><span class="motif-num svelte-1w1m5at"> </span> <!> <span class="motif-name svelte-1w1m5at"> </span> <span class="motif-count svelte-1w1m5at"> </span></button></li>`),Yt=f(`<ul class="motifs-list svelte-1w1m5at"></ul>`),Xt=f(`<div class="motifs svelte-1w1m5at"><!></div>`);function Zt(e,n){s(n,!0);let r=b(n,`activeMotifNumber`,3,null),a=Y();var o=F(),u=L(o),f=e=>{var o=Xt(),s=d(o);{let e=g(()=>a.t(`journal.motifs`));oe(s,{get title(){return l(e)},titleColor:`faint`,children:(e,o)=>{var s=Yt();T(s,21,()=>n.motifs,({hexagram:e,count:t})=>e.number,(e,o)=>{let s=()=>l(o).hexagram,u=()=>l(o).count;var f=Jt(),p=d(f);let m;var h=d(p),g=d(h,!0);v(h);var _=t(h,2);ut(_,{get number(){return s().number},get label(){return s().name},compact:!0});var y=t(_,2),b=d(y,!0);v(y);var S=t(y,2),w=d(S);v(S),v(p),v(f),c(e=>{m=C(p,1,`motif-btn svelte-1w1m5at`,null,m,{active:r()===s().number}),E(p,`aria-label`,e),I(g,s().number),I(b,s().name),I(w,`×${u()??``}`)},[()=>a.t(`journal.openMotif`,{name:s().name})]),i(`click`,p,()=>n.onMotifSelect(s().number)),x(e,f)}),v(s),x(e,s)},$$slots:{default:!0}})}v(o),x(e,o)};N(u,e=>{n.motifs.length>1&&e(f)}),x(e,o),O()}p([`click`]),f(`<p class="paid-body svelte-wqddzm"> </p>`),f(`<!> <!>`,1),f(`<div class="track-form-action svelte-17numxp"><!></div>`);var Qt=f(`<div class="load-more svelte-17numxp" aria-hidden="true"></div>`),$t=f(`<aside class="journal svelte-17numxp"><div class="journal-head svelte-17numxp"><h2 class="svelte-17numxp"> </h2> <div class="journal-head__actions svelte-17numxp"><button type="button" class="journal-action svelte-17numxp"><svg viewBox="0 0 24 24" aria-hidden="true" class="svelte-17numxp"><path d="M12 15V4m0 0L8 8m4-4 4 4"></path><path d="M5 13v6h14v-6"></path></svg></button> <button type="button" class="journal-action svelte-17numxp"><svg viewBox="0 0 24 24" aria-hidden="true" class="svelte-17numxp"><path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13"></path></svg></button> <!></div></div> <!> <!> <!> <!></aside>`),en=f(`<!> <!> <!> <!>`,1);function tn(e,n){s(n,!0);let r=b(n,`activeCastingId`,3,null),o=b(n,`activeMotifNumber`,3,null),f=Y(),p=m(!1),h=m(!1),_=m(!1),y=m(20),S=m(null);function C(){J(`archive_export_opened`),a(h,!0)}function T(){J(`archive_opened`),a(_,!0)}async function D(e){J(`archive_entries_deleted`,{count:e.length}),await X.deleteByIds(e)}let k=g(()=>n.journal.slice(0,l(y))),j=g(()=>bt(l(k),W(f.locale))),M=g(()=>l(y)<n.journal.length),P=g(()=>[..._t(n.journal).entries()].sort((e,t)=>t[1]-e[1]).slice(0,5).map(([e,t])=>({hexagram:$(e,f.locale),count:t})));u(()=>{let e=n.journal.length;l(y)>e?a(y,e,!0):e>0&&l(y)===0&&a(y,Math.min(20,e),!0)});function F(){a(y,Math.min(l(y)+20,n.journal.length),!0)}u(()=>{if(!l(S)||!l(M))return;let e=l(S),t=new IntersectionObserver(e=>{e[0]?.isIntersecting&&F()},{rootMargin:`240px`});return t.observe(e),()=>t.disconnect()});var R=en(),z=L(R),B=e=>{var s=$t(),u=d(s),m=d(u),h=d(m,!0);v(m);var _=t(m,2),y=d(_),b=t(y,2),D=t(b,2);{let e=g(()=>f.t(`journal.helpTitle`));se(D,{get label(){return l(e)},onclick:()=>a(p,!0)})}v(_),v(u);var O=t(u,2);N(O,e=>{});var k=t(O,2);Zt(k,{get motifs(){return l(P)},get activeMotifNumber(){return o()},get onMotifSelect(){return n.onMotifSelect}});var F=t(k,2);qt(F,{get grouped(){return l(j)},get activeCastingId(){return r()},get onEntrySelect(){return n.onEntrySelect}});var L=t(F,2),R=e=>{var t=Qt();A(t,e=>a(S,e),()=>l(S)),x(e,t)};N(L,e=>{l(M)&&e(R)}),v(s),w(s,(e,t)=>te?.(e,t),()=>({event:`journal_panel_viewed`,threshold:.3})),c((e,t,n,r,i)=>{I(h,e),E(y,`aria-label`,t),E(y,`title`,n),E(b,`aria-label`,r),E(b,`title`,i)},[()=>f.t(`journal.title`),()=>f.t(`profile.export`),()=>f.t(`profile.export`),()=>f.t(`profile.clearArchive`),()=>f.t(`profile.clearArchive`)]),i(`click`,y,C),i(`click`,b,T),x(e,s)};N(z,e=>{n.journal.length>0&&e(B)});var V=t(z,2);{let e=g(()=>f.t(`journal.helpTitle`)),t=g(()=>f.t(`journal.helpBody`)),n=g(()=>f.t(`reading.helpClose`));Tt(V,{get open(){return l(p)},get title(){return l(e)},get body(){return l(t)},get closeLabel(){return l(n)},onClose:()=>a(p,!1)})}var H=t(V,2);Mt(H,{get open(){return l(h)},get journal(){return n.journal},onClose:()=>a(h,!1)}),It(t(H,2),{get open(){return l(_)},get journal(){return n.journal},onClose:()=>a(_,!1),onDelete:D}),x(e,R),O()}p([`click`]);var nn=f(`<button type="button"><span class="flag svelte-npjipv" aria-hidden="true"> </span></button>`),rn=f(`<div class="switcher svelte-npjipv" role="group"></div>`);function an(e,t){s(t,!0);let n=Y(),r={uk:{flag:`🇺🇦`,labelKey:`locale.uk`},en:{flag:`🇬🇧`,labelKey:`locale.en`}};function a(e){J(`locale_changed`,{locale:e}),n.setLocale(e)}var o=rn();T(o,21,()=>G,y,(e,t)=>{let o=g(()=>r[l(t)]),s=g(()=>n.t(l(o).labelKey));var u=nn();let f;var p=d(u),m=d(p,!0);v(p),v(u),c(()=>{f=C(u,1,`locale-btn svelte-npjipv`,null,f,{active:n.locale===l(t)}),E(u,`aria-label`,l(s)),E(u,`aria-pressed`,n.locale===l(t)),E(u,`title`,l(s)),I(m,l(o).flag)}),i(`click`,u,()=>a(l(t))),x(e,u)}),v(o),c(e=>{E(o,`aria-label`,e),E(o,`aria-labelledby`,t.labelledBy)},[()=>t.labelledBy?void 0:n.t(`locale.label`)]),x(e,o),O()}p([`click`]);var on=f(`<p class="sync-status svelte-zmcndv"> </p>`),sn=f(`<div class="sync-body svelte-zmcndv"><p class="sync-account svelte-zmcndv"> </p> <!> <a class="sync-privacy svelte-zmcndv" href="https://iching.eggs.gd/privacy" target="_blank" rel="noopener noreferrer"> </a> <!></div>`);function cn(e,n){s(n,!0);let r=Y(),i=g(()=>Z.user?.email??Z.user?.name??``),a=g(()=>{if(!Q.enabled)return null;switch(Q.status){case`syncing`:return r.t(`sync.syncing`);case`error`:return r.t(`sync.error`);default:return Q.lastSyncedAt?r.t(`sync.lastSynced`,{when:o(Q.lastSyncedAt)}):r.t(`sync.blurb`)}});function o(e){let t=Math.round((Date.now()-e)/1e3);if(t<60)return r.t(`sync.justNow`);let n=Math.round(t/60);if(n<60)return r.t(`sync.minutesAgo`,{n});let i=Math.round(n/60);return i<24?r.t(`sync.hoursAgo`,{n:i}):r.t(`sync.daysAgo`,{n:Math.round(i/24)})}async function u(){await Z.signOut(),n.onClose()}{let o=e=>{var n=sn(),o=d(n),s=d(o,!0);v(o);var u=t(o,2),f=e=>{var t=on(),n=d(t,!0);v(t),c(()=>I(n,l(a))),x(e,t)};N(u,e=>{l(a)&&e(f)});var p=t(u,2),m=d(p,!0);v(p);var h=t(p,2),y=e=>{{let t=g(()=>Q.status===`syncing`);H(e,{variant:`primary`,primaryTone:`soft`,fullWidth:!0,get disabled(){return l(t)},onclick:()=>void Q.syncNow(),children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`sync.syncNow`)]),x(e,n)},$$slots:{default:!0}})}};N(h,e=>{Q.enabled&&e(y)}),v(n),c((e,t)=>{I(s,e),I(m,t)},[()=>r.t(`sync.signedInAs`,{account:l(i)}),()=>r.t(`sync.privacy`)]),x(e,n)},s=e=>{H(e,{variant:`danger`,onclick:()=>void u(),children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`sync.signOut`)]),x(e,n)},$$slots:{default:!0}})},f=g(()=>r.t(`sync.title`));V(e,{get open(){return n.open},get title(){return l(f)},titleId:`sync-popup-title`,get onClose(){return n.onClose},children:o,footer:s,$$slots:{default:!0,footer:!0}})}O()}var ln=f(`<span class="sync-btn__dot svelte-19xspq9" aria-hidden="true"></span>`),un=f(`<button type="button"><svg viewBox="0 0 24 24" aria-hidden="true" class="svelte-19xspq9"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"></path></svg> <!></button> <!>`,1);function dn(e,n){s(n,!0);let r=Y(),o=m(!1);function u(){Z.busy||(Z.user?a(o,!0):Z.signIn())}var f=F(),p=L(f),h=e=>{var n=un(),s=L(n);let f;var p=t(d(s),2),m=e=>{x(e,ln())};N(p,e=>{Z.user&&e(m)}),v(s),cn(t(s,2),{get open(){return l(o)},onClose:()=>a(o,!1)}),c((e,t)=>{f=C(s,1,`sync-btn svelte-19xspq9`,null,f,{busy:Z.busy}),s.disabled=Z.busy,E(s,`aria-label`,e),E(s,`title`,t),E(s,`aria-haspopup`,Z.user?`dialog`:void 0)},[()=>Z.user?r.t(`sync.title`):r.t(`sync.signIn`),()=>Z.user?r.t(`sync.title`):r.t(`sync.signIn`)]),i(`click`,s,u),x(e,n)};N(p,e=>{Z.available&&e(h)}),x(e,f),O()}p([`click`]);var fn=f(`<label class="field svelte-94wtrj"><!> <textarea rows="3" class="svelte-94wtrj"></textarea></label>`);function pn(e,n){s(n,!0);let r=Y(),i=m(``),f=g(()=>!!l(i).trim());u(()=>{n.open&&a(i,n.question,!0)});function p(){n.onClose()}function h(){let e=l(i).trim();e&&n.onCast(n.mode,e)}{let s=e=>{var n=fn(),s=d(n);z(s,{children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`flow.questionInputLabel`)]),x(e,n)},$$slots:{default:!0}});var u=t(s,2);o(u),v(n),c(e=>E(u,`placeholder`,e),[()=>r.t(`flow.contextPlaceholder`)]),S(u,()=>l(i),e=>a(i,e)),x(e,n)},u=e=>{{let t=g(()=>!l(f));H(e,{variant:`primary`,get disabled(){return l(t)},onclick:h,children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`flow.castConfirm`)]),x(e,n)},$$slots:{default:!0}})}},m=g(()=>r.t(`flow.contextLabel`)),y=g(()=>r.t(`reading.helpClose`));V(e,{get open(){return n.open},get title(){return l(m)},titleId:`cast-question-popup`,onClose:p,get closeLabel(){return l(y)},children:s,footer:u,$$slots:{default:!0,footer:!0}})}O()}var mn=f(`<!> <span class="trigger-text svelte-i55b03"><span class="trigger-num svelte-i55b03"> </span> <span class="trigger-name svelte-i55b03"> </span></span>`,1),hn=f(`<span class="placeholder svelte-i55b03"> </span>`),gn=f(`<button type="button" class="clear-btn svelte-i55b03">×</button>`),_n=f(`<div class="picker svelte-i55b03"><!> <div class="picker-row svelte-i55b03"><button type="button" class="trigger svelte-i55b03"><!> <!></button> <!></div></div>`);function vn(e,n){s(n,!0);let r=b(n,`value`,3,null),a=Y(),o=g(()=>rt(a.locale)),u=g(()=>r()!==null&&r()!==void 0?l(o).find(e=>e.number===r()):null),f=g(()=>n.placeholder??a.t(`flow.selectHexagram`));function p(e){e.stopPropagation(),n.onClear()}var m=_n(),h=d(m);z(h,{size:`compact`,children:(e,t)=>{_();var r=P();c(()=>I(r,n.label)),x(e,r)},$$slots:{default:!0}});var y=t(h,2),S=d(y),C=d(S),w=e=>{var n=mn(),r=L(n);ut(r,{get number(){return l(u).number},get label(){return l(u).name},compact:!0});var i=t(r,2),a=d(i),o=d(a,!0);v(a);var s=t(a,2),f=d(s,!0);v(s),v(i),c(()=>{I(o,l(u).number),I(f,l(u).name)}),x(e,n)},T=e=>{var t=hn(),n=d(t,!0);v(t),c(()=>I(n,l(f))),x(e,t)};N(C,e=>{l(u)?e(w):e(T,-1)}),ee(t(C,2),{direction:`forward`}),v(S);var D=t(S,2),k=e=>{var t=gn();c(e=>E(t,`aria-label`,e),[()=>a.t(`flow.clearHexagram`)]),i(`click`,t,p),x(e,t)};N(D,e=>{l(u)&&e(k)}),v(y),v(m),i(`click`,S,function(...e){n.onOpen?.apply(this,e)}),x(e,m),O()}p([`click`]);var yn=f(`<div class="preview svelte-1ljsboa"><!> <div class="preview-text svelte-1ljsboa"><span class="preview-num svelte-1ljsboa"> </span> <span class="preview-name svelte-1ljsboa"> </span></div></div>`),bn=f(`<li class="svelte-1ljsboa"><button type="button"><span class="symbol svelte-1ljsboa" aria-hidden="true"> </span> <span class="name svelte-1ljsboa"> </span></button></li>`),xn=f(`<li class="svelte-1ljsboa"><button type="button"><span class="symbol svelte-1ljsboa" aria-hidden="true"> </span> <span class="name svelte-1ljsboa"> </span></button></li>`),Sn=f(`<div class="trigram-view svelte-1ljsboa"><!> <div class="rows svelte-1ljsboa"><div class="row svelte-1ljsboa" role="group"><!> <ul class="trigram-list svelte-1ljsboa"></ul></div> <div class="row svelte-1ljsboa" role="group"><!> <ul class="trigram-list svelte-1ljsboa"></ul></div></div></div>`);function Cn(e,n){s(n,!0);let r=b(n,`value`,3,null),o=Y(),f=m(null),p=m(null);u(()=>{if(r()===null||r()===void 0){a(f,null),a(p,null);return}let{lower:e,upper:t}=Ke(r());a(f,e,!0),a(p,t,!0)});let h=g(()=>l(f)&&l(p)?We(l(f),l(p)):null),S=g(()=>l(h)===null?null:$(l(h),o.locale));function w(e){return o.t(`trigrams.${e}`)}function D(e){a(f,e,!0),A()}function k(e){a(p,e,!0),A()}function A(){!l(f)||!l(p)||n.onSelect(We(l(f),l(p)))}var j=Sn(),M=d(j),F=e=>{var n=yn(),r=d(n);ut(r,{get number(){return l(S).number},get label(){return l(S).name},compact:!0});var i=t(r,2),a=d(i),o=d(a,!0);v(a);var s=t(a,2),u=d(s,!0);v(s),v(i),v(n),c(()=>{I(o,l(S).number),I(u,l(S).name)}),x(e,n)};N(M,e=>{l(S)&&e(F)});var L=t(M,2),R=d(L),B=d(R);z(B,{size:`row`,children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>o.t(`flow.upperTrigram`)]),x(e,n)},$$slots:{default:!0}});var V=t(B,2);T(V,21,()=>Pe,y,(e,n)=>{var r=bn(),a=d(r);let o;var s=d(a),u=d(s,!0);v(s);var f=t(s,2),m=d(f,!0);v(f),v(a),v(r),c((e,t)=>{o=C(a,1,`trigram-btn svelte-1ljsboa`,null,o,{selected:l(p)===l(n)}),E(a,`aria-pressed`,l(p)===l(n)),I(u,e),I(m,t)},[()=>Le(l(n)),()=>w(l(n))]),i(`click`,a,()=>k(l(n))),x(e,r)}),v(V),v(R);var H=t(R,2),U=d(H);z(U,{size:`row`,children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>o.t(`flow.lowerTrigram`)]),x(e,n)},$$slots:{default:!0}});var W=t(U,2);T(W,21,()=>Pe,y,(e,n)=>{var r=xn(),a=d(r);let o;var s=d(a),u=d(s,!0);v(s);var p=t(s,2),m=d(p,!0);v(p),v(a),v(r),c((e,t)=>{o=C(a,1,`trigram-btn svelte-1ljsboa`,null,o,{selected:l(f)===l(n)}),E(a,`aria-pressed`,l(f)===l(n)),I(u,e),I(m,t)},[()=>Le(l(n)),()=>w(l(n))]),i(`click`,a,()=>D(l(n))),x(e,r)}),v(W),v(H),v(L),v(j),c((e,t)=>{E(R,`aria-label`,e),E(H,`aria-label`,t)},[()=>o.t(`flow.upperTrigram`),()=>o.t(`flow.lowerTrigram`)]),x(e,j),O()}p([`click`]);function wn(e,t){let n=b(t,`value`,3,null);V(e,{get open(){return t.open},get title(){return t.title},get titleId(){return t.titleId},get onClose(){return t.onClose},size:`wide`,scrollable:!0,bodyClass:`hex-picker-body`,children:e=>{Cn(e,{get value(){return n()},get onSelect(){return t.onSelect}})},$$slots:{default:!0}})}var Tn=f(`<p class="error svelte-5q67lo" role="alert"> </p>`),En=f(`<form id="prefilled-cast-form" class="form svelte-5q67lo"><label class="field svelte-5q67lo"><!> <textarea rows="3"></textarea></label> <fieldset class="answer-group svelte-5q67lo"><!> <div class="hex-fields svelte-5q67lo"><!> <!></div></fieldset> <!></form>`),Dn=f(`<!> <!> <!>`,1);function On(e,n){s(n,!0);let f=Y(),p=m(null),h=m(null),y=m(null),b=m(null),S=m(!1);function C(){a(b,null),a(y,null),a(p,null),a(h,null),n.onClose()}function w(e){a(y,e,!0),a(b,null)}function T(){a(y,null)}function D(e){l(y)===`primary`?a(p,e,!0):l(y)===`relating`&&a(h,e,!0),T()}async function k(){if(!l(S)){if(!n.question.trim()){a(b,f.t(`flow.manualQuestionRequired`),!0);return}if(l(p)===null||l(p)<1||l(p)>64){a(b,f.t(`flow.manualPrimaryInvalid`),!0);return}a(S,!0),a(b,null);try{if(!await n.onSubmit({question:n.question.trim(),primaryNumber:l(p),relatingNumber:l(h)??void 0})){a(b,f.t(`flow.manualSubmitFailed`),!0);return}C()}finally{a(S,!1)}}}u(()=>{n.open&&(a(b,null),a(y,null))});var A=Dn(),j=L(A);{let e=e=>{var s=En(),u=d(s),m=d(u);z(m,{children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>f.t(`flow.yourQuestion`)]),x(e,n)},$$slots:{default:!0}});var y=t(m,2);o(y),v(u);var S=t(u,2),C=d(S);z(C,{asLegend:!0,children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>f.t(`flow.ichingAnswer`)]),x(e,n)},$$slots:{default:!0}});var T=t(C,2),D=d(T);{let e=g(()=>f.t(`reading.entryHexagramLabel`));vn(D,{get label(){return l(e)},get value(){return l(p)},onOpen:()=>w(`primary`),onClear:()=>a(p,null)})}var O=t(D,2);{let e=g(()=>f.t(`reading.relatingLabel`));vn(O,{get label(){return l(e)},get value(){return l(h)},onOpen:()=>w(`relating`),onClear:()=>a(h,null)})}v(T),v(S);var A=t(S,2),j=e=>{var t=Tn(),n=d(t,!0);v(t),c(()=>I(n,l(b))),x(e,t)};N(A,e=>{l(b)&&e(j)}),v(s),c(e=>{M(y,n.question),E(y,`placeholder`,e)},[()=>f.t(`flow.contextPlaceholder`)]),r(`submit`,s,e=>{e.preventDefault(),k()}),i(`input`,y,e=>n.onQuestionInput(e.currentTarget.value)),x(e,s)},s=e=>{H(e,{variant:`primary`,type:`submit`,form:`prefilled-cast-form`,get disabled(){return l(S)},children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>f.t(`flow.manualSubmit`)]),x(e,n)},$$slots:{default:!0}})},u=g(()=>f.t(`flow.formReady`));V(j,{get open(){return n.open},get title(){return l(u)},titleId:`prefilled-cast-popup`,size:`wide`,onClose:C,children:e,footer:s,$$slots:{default:!0,footer:!0}})}var F=t(j,2);{let e=g(()=>l(y)===`primary`),t=g(()=>f.t(`reading.entryHexagramLabel`));wn(F,{get open(){return l(e)},get title(){return l(t)},titleId:`hex-picker-primary`,get value(){return l(p)},onSelect:D,onClose:T})}var R=t(F,2);{let e=g(()=>l(y)===`relating`),t=g(()=>f.t(`reading.relatingLabel`));wn(R,{get open(){return l(e)},get title(){return l(t)},titleId:`hex-picker-relating`,get value(){return l(h)},onSelect:D,onClose:T})}x(e,A),O()}p([`input`]);var kn=f(`<section class="step question-step svelte-1admqai"><label class="field svelte-1admqai"><div class="group-head svelte-1admqai"><!> <!></div> <textarea rows="3"></textarea></label> <div class="casting svelte-1admqai"><div class="casting-title svelte-1admqai"><!></div> <div class="casting-subsection svelte-1admqai"><div class="group-head svelte-1admqai"><!> <!></div> <div class="casting-options svelte-1admqai"></div></div> <div class="casting-subsection svelte-1admqai"><div class="group-head svelte-1admqai"><!> <!></div> <div class="casting-real-actions svelte-1admqai"><!> <!></div></div></div></section> <!> <!> <!> <!> <!>`,1);function An(e,n){s(n,!0);let r=Y(),u=[`single`,`line`,`all`],f={single:`flow.castSingle`,line:`flow.castLine`,all:`flow.castFull`},p=m(null),h=m(!1),b=m(!1),S=m(!1),C=m(!1),w=m(null);function D(){l(p)?.focus({preventScroll:!0})}function k(e){J(`cast_started`,{method:e}),n.onStartCast(e)}function j(e){if(n.question.trim()){k(e);return}a(w,e,!0)}function F(){a(w,null)}function R(e,t){n.onQuestionInput(t),a(w,null),k(e)}var B={focusInput:D},V=kn(),U=L(V),W=d(U),G=d(W),ee=d(G);z(ee,{children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`flow.contextLabel`)]),x(e,n)},$$slots:{default:!0}});var te=t(ee,2);{let e=g(()=>r.t(`flow.contextHelpTitle`));se(te,{get label(){return l(e)},onclick:()=>a(b,!0)})}v(G);var K=t(G,2);o(K),A(K,e=>a(p,e),()=>l(p)),v(W);var ne=t(W,2),q=d(ne);z(d(q),{children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`flow.castingLabel`)]),x(e,n)},$$slots:{default:!0}}),v(q);var re=t(q,2),X=d(re),Z=d(X);z(Z,{size:`row`,children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`flow.virtualCoinsLabel`)]),x(e,n)},$$slots:{default:!0}});var Q=t(Z,2);{let e=g(()=>r.t(`flow.virtualCoinsHelpTitle`));se(Q,{get label(){return l(e)},onclick:()=>a(S,!0)})}v(X);var ie=t(X,2);T(ie,21,()=>u,y,(e,t)=>{H(e,{variant:`primary`,primaryTone:`soft`,class:`cast-btn`,onclick:()=>j(l(t)),children:(e,n)=>{_();var i=P();c(e=>I(i,e),[()=>r.t(f[l(t)])]),x(e,i)},$$slots:{default:!0}})}),v(ie),v(re);var ae=t(re,2),oe=d(ae),ce=d(oe);z(ce,{size:`row`,children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`flow.realCoinsLabel`)]),x(e,n)},$$slots:{default:!0}});var le=t(ce,2);{let e=g(()=>r.t(`flow.realCoinsHelpTitle`));se(le,{get label(){return l(e)},onclick:()=>a(C,!0)})}v(oe);var ue=t(oe,2),de=d(ue);H(de,{variant:`primary`,primaryTone:`soft`,class:`cast-btn`,onclick:()=>j(`real`),children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`flow.castSingle`)]),x(e,n)},$$slots:{default:!0}}),H(t(de,2),{variant:`primary`,primaryTone:`soft`,class:`cast-btn`,onclick:()=>a(h,!0),children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>r.t(`flow.formReady`)]),x(e,n)},$$slots:{default:!0}}),v(ue),v(ae),v(ne),v(U);var fe=t(U,2),pe=e=>{pn(e,{open:!0,get mode(){return l(w)},get question(){return n.question},onClose:F,onCast:R})};N(fe,e=>{l(w)&&e(pe)});var me=t(fe,2);{let e=g(()=>r.t(`flow.contextHelpTitle`)),t=g(()=>r.t(`flow.contextHelpBody`)),n=g(()=>r.t(`reading.helpClose`));Tt(me,{get open(){return l(b)},get title(){return l(e)},get body(){return l(t)},get closeLabel(){return l(n)},onClose:()=>a(b,!1)})}var he=t(me,2);{let e=g(()=>r.t(`flow.virtualCoinsHelpTitle`)),t=g(()=>r.t(`flow.virtualCoinsHelpBody`)),n=g(()=>r.t(`reading.helpClose`));Tt(he,{get open(){return l(S)},get title(){return l(e)},get body(){return l(t)},get closeLabel(){return l(n)},onClose:()=>a(S,!1)})}var ge=t(he,2);{let e=g(()=>r.t(`flow.realCoinsHelpTitle`)),t=g(()=>r.t(`flow.realCoinsHelpBody`)),n=g(()=>r.t(`reading.helpClose`));Tt(ge,{get open(){return l(C)},get title(){return l(e)},get body(){return l(t)},get closeLabel(){return l(n)},onClose:()=>a(C,!1)})}return On(t(ge,2),{get open(){return l(h)},get question(){return n.question},get onQuestionInput(){return n.onQuestionInput},onClose:()=>a(h,!1),get onSubmit(){return n.onManualCast}}),c(e=>{M(K,n.question),E(K,`placeholder`,e)},[()=>r.t(`flow.contextPlaceholder`)]),i(`input`,K,e=>n.onQuestionInput(e.currentTarget.value)),x(e,V),O(B)}p([`input`]);var jn=f(`<li><span class="line-num svelte-4blq6k"> </span> <span class="line-text svelte-4blq6k"> </span> <!></li>`),Mn=f(`<ol class="line-list svelte-4blq6k"></ol>`),Nn=f(`<!> <!>`,1);function Pn(e,n){s(n,!0);let r=Y(),i=g(()=>new Set(n.changingLines)),o=m(!1);var u=Nn(),f=L(u);{let e=e=>{{let t=g(()=>r.t(`reading.changingLinesHelpTitle`));se(e,{get label(){return l(t)},onclick:()=>a(o,!0)})}},s=g(()=>r.t(`reading.changingLinesTitle`,{lines:n.changingLines.join(`, `)}));oe(f,{get title(){return l(s)},summaryEnd:e,children:(e,a)=>{var o=Mn();T(o,21,()=>re,y,(e,a)=>{let o=g(()=>l(i).has(l(a))),s=g(()=>n.lines?.[l(a)-1]);var u=jn();let f;var p=d(u),m=d(p,!0);v(p);var h=t(p,2),_=d(h,!0);v(h);var y=t(h,2),b=e=>{ke(e,{get line(){return l(s)},compact:!0})};N(y,e=>{l(s)&&e(b)}),v(u),c(e=>{f=C(u,1,`line-item svelte-4blq6k`,null,f,{active:l(o),inactive:!l(o)}),I(m,l(a)),I(_,e)},[()=>U(l(a),r.locale)]),x(e,u)}),v(o),x(e,o)},$$slots:{summaryEnd:!0,default:!0}})}var p=t(f,2);{let e=g(()=>r.t(`reading.changingLinesHelpTitle`)),t=g(()=>r.t(`reading.changingLinesHelpBody`)),n=g(()=>r.t(`reading.helpClose`));Tt(p,{get open(){return l(o)},get title(){return l(e)},get body(){return l(t)},get closeLabel(){return l(n)},onClose:()=>a(o,!1)})}x(e,u),O()}var Fn=f(`<span class="title-row"><span class="title-num"> </span> <!> <span class="title-name"> </span></span>`),In=f(`<span class="layer-mark svelte-sbvn3k" aria-hidden="true">¶</span>`),Ln=f(`<p class="svelte-sbvn3k"><!> </p>`),Rn=f(`<div class="block svelte-sbvn3k"></div>`),zn=f(`<span class="layer-mark svelte-sbvn3k" aria-hidden="true">¶</span>`),Bn=f(`<p class="svelte-sbvn3k"><!> </p>`),Vn=f(`<div class="block svelte-sbvn3k"></div>`),Hn=f(`<span class="layer-mark svelte-sbvn3k" aria-hidden="true">¶</span>`),Un=f(`<p class="svelte-sbvn3k"><!> </p>`),Wn=f(`<div class="block svelte-sbvn3k"></div>`),Gn=f(`<article class="extended"><!> <!> <!></article>`);function Kn(e,n){s(n,!0);let r=`hex-extended-title`,i=g(()=>xt(n.extended.wilhelm_symbolic)),a=g(()=>xt(n.extended.wilhelm_judgment.comments)),o=g(()=>xt(n.extended.wilhelm_image.comments));B(e,{get open(){return n.open},get title(){return n.hexagram.name},titleId:r,get onClose(){return n.onClose},titleContent:e=>{var r=Fn(),i=d(r),a=d(i,!0);v(i);var o=t(i,2);ut(o,{get number(){return n.hexagram.number},compact:!0});var s=t(o,2),l=d(s,!0);v(s),v(r),c(()=>{I(a,n.hexagram.number),I(l,n.hexagram.name)}),x(e,r)},children:(e,n)=>{var s=Gn();E(s,`aria-labelledby`,r);var u=d(s),f=e=>{var n=Rn();T(n,21,()=>l(i),y,(e,n,r)=>{var i=Ln(),a=d(i),o=e=>{x(e,In())};N(a,e=>{r===0&&e(o)});var s=t(a);v(i),c(()=>I(s,` ${l(n)??``}`)),x(e,i)}),v(n),x(e,n)};N(u,e=>{l(i).length>0&&e(f)});var p=t(u,2),m=e=>{var n=Vn();T(n,21,()=>l(a),y,(e,n,r)=>{var i=Bn(),a=d(i),o=e=>{x(e,zn())};N(a,e=>{r===0&&e(o)});var s=t(a);v(i),c(()=>I(s,` ${l(n)??``}`)),x(e,i)}),v(n),x(e,n)};N(p,e=>{l(a).length>0&&e(m)});var h=t(p,2),g=e=>{var n=Wn();T(n,21,()=>l(o),y,(e,n,r)=>{var i=Un(),a=d(i),o=e=>{x(e,Hn())};N(a,e=>{r===0&&e(o)});var s=t(a);v(i),c(()=>I(s,` ${l(n)??``}`)),x(e,i)}),v(n),x(e,n)};N(h,e=>{l(o).length>0&&e(g)}),v(s),x(e,s)},$$slots:{titleContent:!0,default:!0}}),O()}var qn=f(`<div class="label-row svelte-w45o6e"><p class="label svelte-w45o6e"> </p> <!></div>`),Jn=f(`<p class="svelte-w45o6e"> </p>`),Yn=f(`<blockquote class="classical svelte-w45o6e"></blockquote>`),Xn=f(`<span class="layer-mark svelte-w45o6e" aria-hidden="true">¶</span>`),Zn=f(`<p class="svelte-w45o6e"><!> </p>`),Qn=f(`<div><div class="layer-body svelte-w45o6e"></div></div>`),$n=f(`<footer class="extended-footer svelte-w45o6e"><!></footer>`),er=f(`<article class="reading svelte-w45o6e"><!> <header class="header svelte-w45o6e"><span class="number svelte-w45o6e"> </span> <div class="title-block"><div class="title-row svelte-w45o6e"><h2 class="svelte-w45o6e"> </h2> <!></div> <p class="meta svelte-w45o6e"><span class="chinese svelte-w45o6e"> </span> <span class="pinyin"> </span></p> <p class="composition svelte-w45o6e"> </p></div> <!></header> <!> <section class="layers svelte-w45o6e"></section> <!></article> <!> <!>`,1);function tr(e,n){s(n,!0);let r=Y(),i=m(!1),o=m(!1),f=m(!1),p=m(null),h=0,_=g(()=>ct(n.hexagram.number,r.locale)),b=g(()=>n.helpTitleKey?r.t(n.helpTitleKey):``),S=g(()=>n.helpBodyKey?r.t(n.helpBodyKey):``),E=g(()=>[n.hexagram.reading.scene,n.hexagram.reading.dynamics,n.hexagram.reading.vector]),D=g(()=>[n.hexagram.judgment,n.hexagram.image].filter(Boolean));u(()=>{n.hexagram.number,r.locale,h++,a(p,null),a(o,!1),a(f,!1)});async function k(){if(!l(_)||l(f))return;if(J(`extended_reading_opened`,{hexagram_number:n.hexagram.number}),l(p)){a(o,!0);return}let e=++h;a(f,!0);let t=await st(n.hexagram.number,r.locale);e===h&&(a(p,t,!0),a(f,!1),t&&a(o,!0))}var A=er(),j=L(A),M=d(j),P=e=>{var r=qn(),o=d(r),s=d(o,!0);v(o);var u=t(o,2),f=e=>{se(e,{get label(){return l(b)},onclick:()=>{J(`help_opened`,{key:n.helpTitleKey??``}),a(i,!0)}})};N(u,e=>{n.helpTitleKey&&e(f)}),v(r),c(()=>I(s,n.label)),x(e,r)};N(M,e=>{n.label&&e(P)});var R=t(M,2),z=d(R),B=d(z,!0);v(z);var V=t(z,2),H=d(V),U=d(H),W=d(U,!0);v(U);var G=t(U,2),ee=e=>{se(e,{get label(){return l(b)},onclick:()=>{J(`help_opened`,{key:n.helpTitleKey??``}),a(i,!0)}})};N(G,e=>{!n.label&&n.helpTitleKey&&e(ee)}),v(H);var ne=t(H,2),q=d(ne),re=d(q,!0);v(q);var X=t(q,2),Z=d(X,!0);v(X),v(ne);var Q=t(ne,2),ie=d(Q,!0);v(Q),v(V),ut(t(V,2),{get number(){return n.hexagram.number},get label(){return n.hexagram.name}}),v(R);var ae=t(R,2),oe=e=>{var t=Yn();T(t,21,()=>l(D),y,(e,t)=>{var n=F();T(L(n),17,()=>xt(l(t)),y,(e,t)=>{var n=Jn(),r=d(n,!0);v(n),c(()=>I(r,l(t))),x(e,n)}),x(e,n)}),v(t),x(e,t)};N(ae,e=>{l(D).length>0&&e(oe)});var ce=t(ae,2);T(ce,21,()=>l(E),y,(e,n,r)=>{var i=Qn();C(i,1,`layer svelte-w45o6e`,null,{},{vector:r===2});var a=d(i);T(a,21,()=>xt(l(n)),y,(e,n,r)=>{var i=Zn(),a=d(i),o=e=>{x(e,Xn())};N(a,e=>{r===0&&e(o)});var s=t(a);v(i),c(()=>I(s,` ${l(n)??``}`)),x(e,i)}),v(a),v(i),x(e,i)}),v(ce);var le=t(ce,2),ue=e=>{var t=$n(),n=d(t);{let e=g(()=>r.t(`reading.extendedOpen`));K(n,{get label(){return l(e)},onclick:k})}v(t),x(e,t)};N(le,e=>{l(_)&&e(ue)}),v(j),w(j,(e,t)=>te?.(e,t),()=>({event:`hexagram_viewed`,params:{hexagram_number:n.hexagram.number,hexagram_name:n.hexagram.name},key:n.hexagram.number}));var de=t(j,2),fe=e=>{Kn(e,{get open(){return l(o)},get hexagram(){return n.hexagram},get extended(){return l(p)},onClose:()=>a(o,!1)})};N(de,e=>{l(_)&&l(p)&&e(fe)});var pe=t(de,2),me=e=>{{let t=g(()=>r.t(`reading.helpClose`));Tt(e,{get open(){return l(i)},get title(){return l(b)},get body(){return l(S)},get closeLabel(){return l(t)},onClose:()=>a(i,!1)})}};N(pe,e=>{n.helpTitleKey&&e(me)}),c(()=>{I(B,n.hexagram.number),I(W,n.hexagram.name),I(re,n.hexagram.chinese),I(Z,n.hexagram.pinyin),I(ie,n.hexagram.composition)}),x(e,A),O()}var nr=f(`<div class="question-block svelte-1dt6xdp"><p class="question-echo svelte-1dt6xdp"> </p> <!></div>`),rr=f(`<section class="step reading-step svelte-1dt6xdp"><!> <!> <!> <!> <!> <!></section>`);function ir(e,n){s(n,!0);let r=b(n,`relatingHexagram`,3,null),i=Y(),a=g(()=>n.casting.method===`motif`),o=g(()=>!l(a)&&n.casting.changingLines.length>0);var u=rr(),f=d(u),p=e=>{var r=nr(),a=d(r),o=d(a);v(a),H(t(a,2),{variant:`text`,class:`new-cast-link`,get onclick(){return n.onReset},children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>i.t(`flow.newCastLink`)]),x(e,n)},$$slots:{default:!0}}),v(r),c(()=>I(o,`«${n.casting.question??``}»`)),x(e,r)},m=g(()=>!l(a)&&n.casting.question.trim());N(f,e=>{l(m)&&e(p)});var h=t(f,2);{let e=g(()=>i.t(l(o)?`reading.entryHexagramLabel`:`reading.stateHexagramLabel`)),t=g(()=>l(o)?`reading.primaryHexagramHelpTitle`:`reading.stateHexagramHelpTitle`),r=g(()=>l(o)?`reading.primaryHexagramHelpBody`:`reading.stateHexagramHelpBody`);tr(h,{get hexagram(){return n.primaryHexagram},get label(){return l(e)},get helpTitleKey(){return l(t)},get helpBodyKey(){return l(r)}})}var y=t(h,2),S=e=>{Pn(e,{get changingLines(){return n.casting.changingLines},get lines(){return n.casting.lines}})};N(y,e=>{l(o)&&e(S)});var C=t(y,2),w=e=>{{let t=g(()=>i.t(`reading.relatingLabel`));tr(e,{get hexagram(){return r()},get label(){return l(t)},helpTitleKey:`reading.relatingHexagramHelpTitle`,helpBodyKey:`reading.relatingHexagramHelpBody`})}};N(C,e=>{r()&&e(w)});var T=t(C,2);N(T,e=>{}),H(t(T,2),{variant:`primary`,primaryTone:`soft`,fullWidth:!0,class:`cast-btn new-cast`,get onclick(){return n.onReset},children:(e,t)=>{_();var n=P();c(e=>I(n,e),[()=>i.t(`flow.newCast`)]),x(e,n)},$$slots:{default:!0}}),v(u),x(e,u),O()}function ar(e){return qe(Ge(e)).map(e=>({value:e,kind:`young`,changing:!1}))}function or(e,t){let n=ar(e);if(!t||t===e)return n;let r=qe(Ge(t));return n.map((e,t)=>({value:e.value,kind:e.kind,changing:e.value!==r[t]}))}function sr(e){return e.map(e=>e.changing?{...e,value:e.value===`yang`?`yin`:`yang`,changing:!1}:e)}function cr(e){return e.map((e,t)=>e.changing?t+1:null).filter(e=>e!==null)}function lr(e){if(cr(e).length!==0)return He(sr(e))}function ur(e){return new Promise(t=>setTimeout(t,e))}function dr(e){return[{line:e,coin:1},{line:e,coin:2},{line:e,coin:3}]}function fr(){let e=[];for(let t=1;t<=6;t++)e.push(...dr(t));return e}var pr=class{#e=m(`question`);get step(){return l(this.#e)}set step(e){a(this.#e,e,!0)}#t=m(``);get question(){return l(this.#t)}set question(e){a(this.#t,e,!0)}#n=m(`line`);get tossMode(){return l(this.#n)}set tossMode(e){a(this.#n,e,!0)}#r=m(`uk`);get locale(){return l(this.#r)}set locale(e){a(this.#r,e,!0)}#i=m(h([]));get lines(){return l(this.#i)}set lines(e){a(this.#i,e,!0)}#a=m(0);get revealedLines(){return l(this.#a)}set revealedLines(e){a(this.#a,e,!0)}#o=m(null);get casting(){return l(this.#o)}set casting(e){a(this.#o,e,!0)}#s=m(!1);get tossing(){return l(this.#s)}set tossing(e){a(this.#s,e,!0)}#c=m(h([]));get coinRows(){return l(this.#c)}set coinRows(e){a(this.#c,e,!0)}#l=m(h([]));get currentLineCoins(){return l(this.#l)}set currentLineCoins(e){a(this.#l,e,!0)}#u=m(null);get spinningLine(){return l(this.#u)}set spinningLine(e){a(this.#u,e,!0)}#d=m(null);get spinningCoin(){return l(this.#d)}set spinningCoin(e){a(this.#d,e,!0)}runId=0;get activeLine(){return this.lines.length>=6?null:this.spinningLine===null?this.currentLineCoins.length>0?this.lines.length+1:null:this.spinningLine}get lineCoins(){let e=Array.from({length:6});for(let t=0;t<this.coinRows.length;t++)e[t]=[...this.coinRows[t]];if(this.currentLineCoins.length>0){let t=[void 0,void 0,void 0];for(let e=0;e<this.currentLineCoins.length;e++)t[e]=this.currentLineCoins[e];e[this.coinRows.length]=t}return e}get coinGridRevealed(){return Math.max(this.revealedLines,this.lines.length+ +(this.currentLineCoins.length>0))}setLocale(e){this.locale=e}setQuestion(e){this.question=e}async startCast(e){if(!this.question.trim())return;let t=this.startRun();if(this.tossMode=e,this.clearCurrentCast(),e===`all`){await this.runAllToss(t);return}this.isCurrentRun(t)&&(this.step=`toss`)}async startManualCast(e,t,n){let r=e.trim();if(!r||!Je(t)||n!==void 0&&!Je(n))return!1;this.startRun(),this.clearCurrentCast(),this.question=r;let i=or(t,n),a=cr(i),o=n!==void 0&&n!==t?n:a.length>0?lr(i):void 0,s={id:vt(),createdAt:new Date().toISOString(),question:r,primaryNumber:t,relatingNumber:o,changingLines:a,lines:i,locale:this.locale,method:`manual`};return this.lines=i,this.revealedLines=6,this.coinRows=gt(s),this.currentLineCoins=[],await X.save(s),J(`casting_completed`,{hexagram_number:t,method:`manual`}),this.casting=s,this.step=`reading`,!0}async tossNext(){this.tossMode===`line`?await this.tossNextLine():this.tossMode===`single`&&await this.tossNextCoin()}reset(){this.runId++,this.step=`question`,this.question=``,this.clearCurrentCast(),this.tossing=!1}viewJournalEntry(e){this.runId++,this.question=e.question,this.lines=e.lines,this.revealedLines=6,this.coinRows=gt(e),this.currentLineCoins=[],this.spinningLine=null,this.spinningCoin=null,this.tossing=!1,this.casting=e,this.step=`reading`}viewHexagram(e){if(!Je(e))return;this.runId++;let t=ar(e);this.casting={id:`motif-${e}`,createdAt:new Date().toISOString(),question:``,primaryNumber:e,changingLines:[],lines:t,locale:this.locale,method:`motif`},this.question=``,this.lines=t,this.revealedLines=6,this.coinRows=gt(this.casting),this.currentLineCoins=[],this.spinningLine=null,this.spinningCoin=null,this.tossing=!1,this.step=`reading`}startRun(){return this.runId++,this.runId}isCurrentRun(e){return e===this.runId}ensureCoinRow(e){for(;this.coinRows.length<e;)this.coinRows=[...this.coinRows,[void 0,void 0,void 0]]}setCoinValue(e,t,n){this.ensureCoinRow(e);let r=[...this.coinRows[e-1]];r[t-1]=n,this.coinRows=this.coinRows.map((t,n)=>n===e-1?r:t)}async spinRevealCoin(e,t,n,r){return!this.isCurrentRun(e)||(this.tossing=!0,this.spinningLine=t,this.spinningCoin=n,await ur(660),!this.isCurrentRun(e))?!1:(await ne(),r(),this.spinningCoin=null,this.isCurrentRun(e))}resolvedCoinRows(){return this.coinRows.map(e=>e)}clearCurrentCast(){this.lines=[],this.revealedLines=0,this.casting=null,this.coinRows=[],this.currentLineCoins=[],this.spinningLine=null,this.spinningCoin=null}async runAllToss(e){this.step=`toss`,this.coinRows=[],this.lines=[],this.revealedLines=0;let{lines:t,coinRows:n}=_e();for(let{line:r,coin:i}of fr()){let a=n[r-1][i-1],o=t[r-1];if(!await this.spinRevealCoin(e,r,i,()=>{this.setCoinValue(r,i,a),i===3&&(this.lines=[...this.lines,o],this.revealedLines=r)}))return}this.tossing=!1,this.spinningLine=null,this.isCurrentRun(e)&&await this.finishCasting(t)}async tossNextLine(){if(this.lines.length>=6||this.tossing)return;let e=this.runId,t=this.lines.length+1,n=de();this.currentLineCoins=[];for(let r=1;r<=3;r++){let i=n.coins[r-1];if(!await this.spinRevealCoin(e,t,r,()=>{this.currentLineCoins=[...this.currentLineCoins,i]}))return}this.tossing=!1,this.spinningLine=null,this.coinRows=[...this.coinRows,[...n.coins]],this.currentLineCoins=[];let r=[...this.lines,n.lines[0]];if(this.lines=r,this.revealedLines=r.length,r.length===6){if(await ur(400),!this.isCurrentRun(e))return;await this.finishCasting(r)}}async tossNextCoin(){await this.tossCoin(le())}async tossRealCoin(e){await this.tossCoin(e)}async tossCoin(e){if(this.lines.length>=6||this.tossing)return;let t=this.runId,n=this.lines.length+1,r=this.currentLineCoins.length+1;if(!await this.spinRevealCoin(t,n,r,()=>{this.currentLineCoins=[...this.currentLineCoins,e]}))return;this.tossing=!1,this.spinningLine=null;let i=this.currentLineCoins;if(i.length<3)return;this.coinRows=[...this.coinRows,i];let a=[...this.lines,fe(i)];if(this.lines=a,this.revealedLines=a.length,this.currentLineCoins=[],a.length===6){if(await ur(400),!this.isCurrentRun(t))return;await this.finishCasting(a)}}async finishCasting(e){await ie();let t=He(e),n=lr(e),r=cr(e),i={id:vt(),createdAt:new Date().toISOString(),question:this.question.trim(),primaryNumber:t,relatingNumber:n,changingLines:r,lines:e,coinRows:this.resolvedCoinRows(),locale:this.locale,method:this.tossMode};await X.save(i),J(`casting_completed`,{hexagram_number:t,method:this.tossMode}),this.casting=i,this.step=`reading`}};function mr(){return new pr}function hr(e){let t=e.get(`q`);return t===null?null:t.trim()||null}var gr=f(`<div><!></div>`),_r=f(`<div><!></div>`),vr=f(`<!> <main><header class="site-header svelte-1uha8ag"><div class="site-header__sync svelte-1uha8ag"><!></div> <div class="site-header__locale svelte-1uha8ag"><!></div> <h1 class="logo svelte-1uha8ag">易經</h1> <p class="tagline svelte-1uha8ag"> </p></header> <!> <!> <!> <!></main>`,1);function yr(n,r){s(r,!0);let i=Y(),o=mr(),f=m(null),p=m(null),h=m(!1),_=m(!1),y=m(!1),b=g(()=>o.casting?$(o.casting.primaryNumber,i.locale):null),S=g(()=>o.casting?.relatingNumber?$(o.casting.relatingNumber,i.locale):null),w={get step(){return o.step},get tossMode(){return o.tossMode},get lineCoins(){return o.lineCoins},get lines(){return o.lines},get spinningLine(){return o.spinningLine},get spinningCoin(){return o.spinningCoin},get revealedLines(){return o.revealedLines},get coinGridRevealed(){return o.coinGridRevealed},get activeLine(){return o.activeLine},get tossing(){return o.tossing},onTossNext:()=>o.tossNext(),onRealCoin:e=>o.tossRealCoin(e)};u(()=>{o.setLocale(i.locale)}),u(()=>{if(o.step===`toss`){a(h,!0),document.documentElement.classList.add(`immersive-cast`);let e=requestAnimationFrame(()=>{requestAnimationFrame(()=>{a(_,!0),a(y,!0)})});return()=>cancelAnimationFrame(e)}if(!l(h))return;a(_,!1),a(y,!1);let e=setTimeout(()=>{a(h,!1),document.documentElement.classList.remove(`immersive-cast`)},1500);return()=>clearTimeout(e)}),u(()=>{let e=o.casting;!e||e.method===`motif`||X.entries.some(t=>t.id===e.id)||o.reset()});function T(){let e=hr(ce.url.searchParams);if(!e)return null;let t=new URL(ce.url);return t.searchParams.delete(`q`),R(`${t.pathname}${t.search}${t.hash}`,ce.state),e}k(()=>{let e=!1;return(async()=>{if(await X.load(),e)return;let t=T();t&&(o.setQuestion(t),J(`cast_started`,{method:`all`}),o.startCast(`all`))})(),()=>{e=!0,document.documentElement.classList.remove(`immersive-cast`)}});async function E(t){J(`journal_entry_opened`,{hexagram_number:t.primaryNumber}),o.viewJournalEntry(t),await e(),l(f)?.scrollIntoView({behavior:`smooth`,block:`start`})}async function j(t){J(`motif_viewed`,{hexagram_number:t}),o.viewHexagram(t),await e(),l(f)?.scrollIntoView({behavior:`smooth`,block:`start`})}async function M(){o.reset(),await e(),l(p)?.focusInput(),window.scrollTo({top:0,left:0,behavior:`smooth`})}async function P(t){return await o.startManualCast(t.question,t.primaryNumber,t.relatingNumber)?(await e(),l(f)?.scrollIntoView({behavior:`smooth`,block:`start`}),!0):!1}var F=vr(),z=L(F),B=e=>{var t=gr();let n;var r=d(t);{let e=g(()=>l(_)?o.step:`toss`);ht(r,D(()=>w,{get step(){return l(e)},immersive:!0}))}v(t),c(()=>n=C(t,1,`cast-overlay svelte-1uha8ag`,null,n,{"cast-overlay--visible":l(_)})),x(e,t)};N(z,e=>{l(h)&&e(B)});var V=t(z,2);let H;var U=d(V),W=d(U);dn(d(W),{}),v(W);var G=t(W,2);an(d(G),{}),v(G);var ee=t(G,4),te=d(ee,!0);v(ee),v(U);var K=t(U,2),ne=e=>{A(An(e,{get question(){return o.question},onQuestionInput:e=>o.setQuestion(e),onStartCast:e=>o.startCast(e),onManualCast:P}),e=>a(p,e,!0),()=>l(p))};N(K,e=>{o.step===`question`&&e(ne)});var q=t(K,2),re=e=>{ht(e,D(()=>w))};N(q,e=>{o.step===`reading`&&o.casting?.method!==`motif`&&e(re)});var Z=t(q,2),Q=e=>{var t=_r();ir(d(t),{get casting(){return o.casting},get primaryHexagram(){return l(b)},get relatingHexagram(){return l(S)},onReset:M}),v(t),A(t,e=>a(f,e),()=>l(f)),x(e,t)};N(Z,e=>{o.step===`reading`&&o.casting&&l(b)&&e(Q)});var ie=t(Z,2);{let e=g(()=>o.step===`reading`&&o.casting?.method!==`motif`?o.casting?.id:null),t=g(()=>o.step===`reading`&&o.casting?.method===`motif`?o.casting.primaryNumber:null);tn(ie,{get journal(){return X.entries},get activeCastingId(){return l(e)},get activeMotifNumber(){return l(t)},onEntrySelect:E,onMotifSelect:j})}v(V),c(e=>{H=C(V,1,`main svelte-1uha8ag`,null,H,{"main--faded":l(y)}),I(te,e)},[()=>i.t(`app.tagline`)]),x(n,F),O()}export{yr as component};